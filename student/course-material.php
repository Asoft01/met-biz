            ...
            <div class="col-lg-9">
                <div class="card assignment-info">
                    <div class="card-header assignment-ttle">
                        <i class="fa fa-university"></i> MBA - Classroom (Course Materials)
                    </div>
                    <div class="card-body assignment-modules">
                        <div class="card assignment-modules-info">
                            ...
                            <div class="card-body">
                                ...
                                <table class="table table-striped assignment-table-info">
                                    ...
                                    <tbody>
                                        <tr>
                                            <th scope="row"><a href="">Research Method 101</a></th>
                                            <td><button class="btn btn-dark btn-lg btn-view">Download</button></td>

                                        </tr>
                                        <tr>
                                            <th scope="row"><a href="">Enterprise and Entrepreurship Research Method 105</a></th>
                                            <td><button class="btn btn-dark btn-lg btn-view">Download </button></td>
                        ...
                        <div class="card assignment-modules-info">
                            <div class="card-header">
                                <i class="fa fa-book"></i> Enterprise And Entrepreurship (ENT)
                            </div>
                            <div class="card-body">
                                <table class="table table-striped assignment-table-info">
                                    <thead class="thead-dark">
