...
<div class="bottom-footer bg-white shadow pt-3 pb-3">
    <div class="container-fluid">
        <div class="row align-items-center">
            <div class="col-lg-2 col-6 mb-1">
                <a href="<?php echo ROOT_DIR; ?>student/interactive-6.php" class="btn btn-dark btn-block text-uppercase btn-sm make-bold border-secondary lt-2 btn-bord-radius"><i class="fa fa-chevron-left"></i> <span class="">Previous</span></a>
            </div>
            <div class="col-lg-8 d-none d-lg-inline-block d-xl-inline-block mb-1">
            ...
            <div class="col-lg-2 col-6 mb-1">
                ...
                <a href="<?php echo ROOT_DIR; ?>student/interactive-8.php" class="btn btn-info text-white btn-block text-uppercase btn-sm make-bold border-white lt-2 btn-bord-radius"><span class="d-none d-lg-inline-block d-xl-inline-block">Give me a</span> hint</a>
            </div>
        </div>
    </div>
</div>
