                                    ...
                                    <div class="card-footer bg-black">
                                        <div class="d-flex text-white justify-content-between align-items-center">
                                            ...
                                            <div class="interactive-status-action">
                                                <h3 class="make-bold btn btn-outline-dark make-bold ft-2">Start <i class="fa fa-chevron-right"></i></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card card-height text-dark">
                                    ...
                                    <div class="card-footer">
                                        <div class="d-flex text-white justify-content-between align-items-center">
                                            ...
                                            <div class="interactive-status-action">
                                                <h3 class="make-bold btn btn-outline-dark make-bold ft-2">Resume <i class="fa fa-play"></i></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card card-height text-dark">
                                    ...
                                    <div class="card-footer">
                                        <div class="d-flex text-white justify-content-between align-items-center">
                                            ...
                                            <div class="interactive-status-action">
                                                <h3 class="make-bold btn btn-outline-dark make-bold ft-2">Locked <i class="fa fa-lock"></i></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
