            ...
            <div class="row">
                <div class="col-lg-8 mx-auto">
                    ...
                    <div class="question-interactive-options text-center">
                        <p class="text-muted make-bold">Select multiple answers</p>
                        <hr/>
                        <div class="row">
                            <div class="col-lg-6 mb-3">
                                <div class="card card-height bg-success text-white btn-bord-radius card-option-view cursor-pointer">
                                    <div class="card-body">
                                        Lorem ipsum dolor sit amet consectetur, adipisicing elit. Aperiam, necessitatibus nesciunt molestias non quis facilis reiciendis doloremque reprehenderit voluptate dolorum inventore nostrum illo sit dolores esse odio commodi. Sequi, placeat!
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6 mb-3">
    ...
    <div class="container-fluid">
        <div class="row align-items-center">
            <div class="col-lg-2 col-6 mb-1">
                <a href="<?php echo ROOT_DIR; ?>student/interactive-4.php" class="btn btn-dark btn-block text-uppercase btn-sm make-bold border-secondary lt-2 btn-bord-radius"><i class="fa fa-chevron-left"></i> <span class="">Previous</span></a>
            </div>
            ...
            <div class="col-lg-2 col-6 mb-1">
                ...
                <a href="<?php echo ROOT_DIR; ?>student/interactive-6.php" class="btn btn-purple btn-block text-uppercase btn-sm make-bold border-white lt-2 btn-bord-radius">Next <i class="fa fa-chevron-right"></i></a>
            </div>
        </div>
    </div>
</div>
