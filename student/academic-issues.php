                ...
                <div class="card assignment-info acad-issues">
                    <div class="card-header assignment-title acad-header">
                        <div class="row">
                            ...
                            <div class="col-6">
                                <button class="btn btn-dark float-right">Send a message</button>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12 mb-2">
                                <p>Please send us a message if you have questions about your</p>
                                <ul class="acad-list">
                                    <li>Course Content</li>
                                    <li>Assignments</li>
                                    <li>Students</li>
                                </ul>
                                <strong class="text-danger">Please make sure to contact the relevant department to ensure proper follow up</strong>
                            </div>
                            ...
                            <div class="table-responsive-lg">
                                <table class="table table-striped assignment-table-info">
                                    ...
                                    <tbody>
                                        <tr>
                                            <th>1</th>
                                            <td>Jan 29, 2019 - 03:59pm</td>
                                            <td><a href="">Unable to access my assignment</a></td>
                                            <td>Open</td>
                                            <td><button class="btn btn-dark btn-sm btn-view">View Details</button></td>
                                            <td><button class="btn btn-danger btn-sm btn-view">Close</button></td>
                                            <td><button class="btn btn-dark btn-sm btn-view">Solved</button></td>
                                        </tr>
                                        <tr>
                                            <th>2</th>
                                            <td>Jan 29, 2019 - 03:59pm</td>
                                            <td><a href="">Unable to submit assignment</a> </td>
                                            <td>Open</td>
                                            <td><button class="btn btn-dark btn-sm btn-view">View Details</button></td>
                                            <td><button class="btn btn-danger btn-sm btn-view">Close</button></td>
                                            <td><button class="btn btn-dark btn-sm btn-view">Solved</button></td>
