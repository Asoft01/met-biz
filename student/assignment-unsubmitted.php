            ...
            <div class="col-lg-9">
                <div class="card assignment-info">
                    <div class="card-header assignment-ttle">
                        <i class="fa fa-university"></i> MBA - Classroom (Unsubmitted Assignments)
                    </div>
                    <div class="card-body assignment-modules">
                        <table class="table table-responsive-lg table-striped assignment-table-info">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>Global Strategic Marketing</td>
                                    <td>Marketing 101</td>
                                    <td>Sept 08, 2020</td>
                                    <td>
                                        <badge class="badge badge-warning">Pending</badge>
