    ...
    <div class="container-fluid">
        <div class="row flex-column-reverse flex-lg-row">
            <div class="col-lg-12 statistics">
                <h4 class="mb-4 make-bold text-center">Business Information</h4>
                    ...
                    <div class="assign-container">
                        ...
                        <div class="row">
                            <div class="col-lg-5 mx-auto mb-3">
                                <div class="card">
                                    <div class="card-body">
                                        <small class="mb-0 text-muted text-uppercase letter-space">Enter your profile credentials below</small>
                                        <hr/>
                                        <form>
                                            <div class="form-group">
                                                <label>Business Name</label>
                                                <input type="text" class="form-control form-control-lg" placeholder="Enter Business Name" />
                                            </div>
                                            <div class="form-group">
                                                <label>Business Address</label>
                                                <input type="text" class="form-control form-control-lg" placeholder="Business Address" />
                                            </div>
                                            <div class="form-group">
                                                <label>Business Phone</label>
                                                <input type="text" class="form-control form-control-lg" placeholder="Business Phone" />
                                            </div>
                                            <div class="form-group">
                                                <label>Country</label>
