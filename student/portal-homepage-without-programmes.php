    ...
    <div class="container">
        <div class="row flex-column-reverse flex-lg-row">
            ...
            <div class="col-lg-9 statistics">
                ...
                <div class="no-programme-sect">
                    <h3 class="mb-4">You have no programme at the moment.</h3>
                    <h4>See suggestions below to start taking courses.</h4>
                </div>

                <div class="find">
                    <div class="container">
                        <p class="heading-find">Recommended Courses based on your profile</p>
                        <div class="row myflexx">
                                ...
                                <a href="" class="card-ahref-flex">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="card-info-btn">
                                            <button class="btn btn-dark btn-block mt-auto">Course Learning</button>
                                        </div>
                                    </div>
                                </a>
                            </div>
                            ...
                            <div class="col-md-6 col-12 col-lg-6 col-xl-4 card">
                                <a href="" class="card-ahref-flex">
                                    ...
                                    <div class="card-img-wrap">
                                        <img src="../images/bg8.jpg" class="card-img-top" alt="...">
                                    </div>
                                    <div class="card-body">
                                        <p class="card-text card-uni">UK Partner University</p>
                                        <h6 class="card-title">MBA<br>Master of Business Adminstration(MBA)</h6>
