...
<div class="lecture-v-portal">
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper" class="pb-5">
            <div class="container">
               <div class="question-container pad-top-100">
                    <div class="row">
                       <div class="col-lg-8 mx-auto">
                            ...
                            <div class="alert alert-success" role="alert">
                                <div class="quiz-result-status text-center-sm">
                                    ...
                                    <div class="congrate-text quiz-result-sect">
                                        <form action="<?php echo ROOT_DIR; ?>student/lecture-quiz-question.php">
                                           <button class="btn btn-danger btn-block btn-sm">Retake Quiz</button>
                                        </form>
