...
<div class="student_portal margin-top-00">
    <div class="container">
        ...
        <form action="<?php echo ROOT_DIR; ?>student/interactive-4.php" method="post">
            <div class="row">
                <div class="col-lg-8 mx-auto">
                    ...
                    <div class="question-container-view text-center my-3">
                        <p>2. <strong>Nonhuman Resources</strong> include the following</p>
                ...
                <div class="col-lg-12">
                    <div class="question-interactive-submit d-flex justify-content-between align-items-center">
                        <div>
                            <a href="#" class="btn btn-info btn-bord-radius btn-lg disabled">Previous</a>
                        </div>
                        <div>
