            ...
            <div class='row '>
                <div class='col-lg-8 mx-auto about-msbm'>
                    ...
                    <div class="terms-content">
                        <h3 class="terms-content-heading">Our Values</h3>
                        <div class="wpb_wrapper">
                            <p>Our Values are built around working together in achieving our mission and vision – living by them keeps us focused. Our Values are built around core principles such as…</p>

                            <h4>Respectful</h4>
                            <p>We are a dedicated team of people from all over the world who are honest, trustworthy and responsible.</p>
                            <h4>Dream Big</h4>
                            <p>We are never afraid to dream Big. We dream and we work toward achieving our dreams.</p>
                            <h4>Passionate</h4>
                            <p>We are flexible, energetic and strive to exceed expectations.</p>
                            <h4>Supportive</h4>
                            <p>We help our learners, our partners and each other to pull through together, openly help and always support each other.</p>
                            <h4>Learn together</h4>
                            <p>We listen to and address the needs of our learners and partners, celebrating our successes and learning from our failures.</p>
