        ...
        <div class="container">
            <div class='row '>
                <div class='col-lg-8 worldwide-cols degree-info-accordion'>
                    <h3>Regular changes on the website</h3>
                            ...
                            <div class="categories-select">
                                <form action="#" method="POST" id="term-select-nav">
                                    <select class="terms-category form-control" name="terms-category" onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);">
                                        ...
                                        <option value="<?php echo ROOT_DIR; ?>regular-changes-to-our-website.php" selected="selected">Regular Changes to our Website</option>
                    ...
                    <div class="terms-content">
                        <div class="wpb_wrapper">
                            <p>We aim to update our website regularly, and may change the content at any time. If the need arises, we may suspend access to our site, or close it indefinitely. </p>
                            <p>Any of the material on our site may be out of date at any given time, and we are under no obligation to update such material.
                                For more information or clarification on any of the materials on our website, we suggest you send an email to <a href="mailto:info@msbm.org.uk">info@msbm.org.uk</a>.
                            </p>
                        </div>
                    </div>
                </div>
