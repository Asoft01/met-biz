...
<div class="main-landing-page ipdg-dm">
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <div class="landing-position">
                        <div>
                            <h1 class="mba-header"><strong>International Postgraduate Diploma in Digital Marketing</strong> (Level 7)</h1>
                    ...
                    <div class="accordion mb-5" id="msbmAccordion">
                            ...
                            <div class="card-header" id="headingOne">
                                <h2 class="mb-0">
                                    <button class="btn btn-link btn-block" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                        International Postgraduate Diploma in Digital Marketing <i class="fa fa-chevron-down float-right"></i>
                                    ...
                                    <div class="wpb_wrapper">
                                        ...
                                        <table class="table table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td width="482">Digital Marketing</td>
                                                    <td width="155">20</td>
                                                </tr>
                                                <tr>
                                                    <td width="482">Strategic Marketing</td>
                                                    <td width="155">20</td>
                                                </tr>
                                                <tr>
                                                    <td width="482">Search Engine Optimization (SEO)</td>
                                                    <td width="155">20</td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <td width="482">Marketing & Consumer Behavior</td>
                                                    <td width="155">20</td>
                                                </tr>
                                                <tr>
                                                    <td width="482">Digital Marketing Planning</td>
                                                    <td width="155">20</td>
                                                </tr>
                                                <tr>
                        ...
                        <div class="card">
                            ...
                            <div id="collapseFour" class="collapse" aria-labelledby="headingFour">
                                <div class="card-body">
                                    <div class="wpb_wrapper">
                                        <p>The MSBM Level 7 Diploma in Digital Marketing&nbsp; &nbsp;programme&nbsp; enables learners to progress into or within employment and/or continue their further study by topping up the degree with Masters in Digital Marketing&nbsp; &nbsp;at certain Universities in the UK.</p>
                            ...
                            <div class="card-header" id="headingSix">
                                <h2 class="mb-0">
                                    <button class="btn btn-link collapsed btn-block" type="button" data-toggle="collapse" data-target="#collapseSix" aria-expanded="false" aria-controls="collapseSix">
                                        Module 1: DIGITAL MARKETING <i class="fa fa-chevron-down float-right"></i>
                                        <i class="fa fa-chevron-up float-right"></i>
                                    </button>
                                </h2>
                            </div>
                            <div id="collapseSix" class="collapse" aria-labelledby="headingSix">
                                <div class="card-body">
                                    <div class="wpb_wrapper">
                                        ...
                                        <p>The aim of the Digital Marketing Course is to provide students with the knowledge about business advantages of the digital marketing and its importance for marketing success. The application of the gained knowledge, skills and competences will help future managers in forming digital marketing plan in order to manage a digital marketing performance efficiently.</p>
                                        <p><strong>Learning Outcomes</strong></p>
                                        <ul>
                                            <li>To develop the understanding of a digital marketing plan; to make SWOT analysis; to define a target group and to get introduced to various digital channels,</li>
                                            <li>Comprehensive understanding of the role of marketing communications in achieving organisational objectives</li>
                                            <li>To understand how to integrate different digital media and create marketing content;</li>
                                            <li>To get basic knowledge of Google Analytics for measuring effects of digital marketing and getting insight of future trends that will affect the future development of the digital marketing.</li>
                                        </ul>
                        ...
                        <div class="card">
                            <div class="card-header" id="headingSeven">
                                <h2 class="mb-0">
                                    <button class="btn btn-link collapsed btn-block" type="button" data-toggle="collapse" data-target="#collapseSeven" aria-expanded="false" aria-controls="collapseSeven">
                                        Module 2: SEARCH ENGINE OPTIMIZATION (SEO) <i class="fa fa-chevron-down float-right"></i>
                                        <i class="fa fa-chevron-up float-right"></i>
                                    </button>
                                </h2>
                            </div>
                            <div id="collapseSeven" class="collapse" aria-labelledby="headingSeven">
                                <div class="card-body">
                                    <div class="wpb_wrapper">
                                        <p><strong>Module Aim</strong></p>
                                        <p>The Search Marketing: SEO module will help you to understand the concept of Search Engine Optimization (SEO) and how you can leverage key techniques to improve your website’s organic ranking on search engine results pages (SERPS) to drive more traffic. It also covers key terminology and technical insights necessary to cultivate an effective SEO strategy.</p>
                                        <p><strong>Learning Outcomes</strong></p>
                                        <ul>
                                            <li>Understanding of the key concepts and terminology used within the field of SEO</li>
                                            <li>Understanding and insight to build and maintain an effective SEO strategy.</li>
                                            <li>Delegates would learn about the range of specialist tools that are available to help common search engines find, view and rate websites.</li>
                                            <li>Understanding of the concept of ranking and be able to perform a range of off-page optimization activities to improve your site ranking and positioning, such as link building</li>
                                            <li>Awareness of data protection and privacy issues associated with SEO.</li>
                                        </ul>
                        ...
                        <div class="card">
                            <div class="card-header" id="headingEight">
                                <h2 class="mb-0">
                                    <button class="btn btn-link collapsed btn-block" type="button" data-toggle="collapse" data-target="#collapseEight" aria-expanded="false" aria-controls="collapseEight">
                                        Module 3: MARKETING & CONSUMER BEHAVIOUR <i class="fa fa-chevron-down float-right"></i>
                                        <i class="fa fa-chevron-up float-right"></i>
                                    </button>
                                </h2>
                            </div>
                            <div id="collapseEight" class="collapse" aria-labelledby="headingEight">
                                <div class="card-body">
                                    <div class="wpb_wrapper">
                                        <p><strong>Module Aim</strong></p>
                                        <p>This unit aims to provide candidates with the skills and knowledge necessary in managing marketing communications and brand support activities within organisations. The unit explains the links between communications and marketing and provides knowledge of fundamental theories and techniques of research and consumer behaviour, and their application to marketing communications.</p>
                                        <p><strong>Learning Outcomes</strong></p>
                                        <ol>
                                            <li>Be able to explain the role of the marketing plan and communications plan within the context of the organization’s strategy and culture</li>
                                            <li>Be able to describe the marketing planning process and the links between each stage of the process</li>
                                            <li>Be able to outline the principles of marketing research, how data can be obtained through both primary and secondary methods</li>
                                            <li>Be able to recommend suitable methods to influence the relationships an organization has with its customers. Any marketing channel partners and other stakeholders using marketing communications</li>
                                        </ol>
                        ...
                        <div class="card">
                            <div class="card-header" id="headingEleven">
                                <h2 class="mb-0">
                                    <button class="btn btn-link collapsed btn-block" type="button" data-toggle="collapse" data-target="#collapseEleven" aria-expanded="false" aria-controls="collapseEleven">
                                        Module 4: DIGITAL MARKETING PLANNING <i class="fa fa-chevron-down float-right"></i>
                                        <i class="fa fa-chevron-up float-right"></i>
                                    </button>
                                </h2>
                            </div>
                            <div id="collapseEleven" class="collapse" aria-labelledby="headingEleven">
                                <div class="card-body">
                                    <div class="wpb_wrapper">
                                        <p><strong>Module Aim</strong></p>
                                        <p>This unit aims to provide candidates with the skills and knowledge to understand the fundamental digital marketing planning concepts for an organisation, together with key factors involved with the implementation, measurement and evaluation of successful campaigns</p>
                                        <p><strong>Learning Outcomes</strong></p>
                                        <ol>
                                            <li>Ability to appraise different digital planning approached and marketing environmental factors that influence online marketing activity</li>
                                            <li>Review similarities and differences between digital and traditional marketing concept and applications</li>
                                            <li>Discuss key stages in online development using relevant business models</li>
                                            <li>Analyze the ways in which the internet has affected marketing mix elements and how organisations employ them creatively in the digital environment</li>
                                            <li>Ability to apply relevant tools and concepts to design measure and monitor an online digital marketing plan</li>
                                        </ol>
                            ...
                            <div class="card-header" id="headingNine">
                                <h2 class="mb-0">
                                    <button class="btn btn-link collapsed btn-block" type="button" data-toggle="collapse" data-target="#collapseNine" aria-expanded="false" aria-controls="collapseNine">
                                        Module 5: RESEARCH PROJECT <i class="fa fa-chevron-down float-right"></i>
                                        <i class="fa fa-chevron-up float-right"></i>
                                    </button>
                                </h2>
                            </div>
                            ...
                            <div class="card-header" id="headingTen">
                                <h2 class="mb-0">
                                    <button class="btn btn-link collapsed btn-block" type="button" data-toggle="collapse" data-target="#collapseTen" aria-expanded="false" aria-controls="collapseTen">
                                        Module 6: STRATEGIC MARKETING <i class="fa fa-chevron-down float-right"></i>
                                        <i class="fa fa-chevron-up float-right"></i>
                                    </button>
                                </h2>
                            </div>
