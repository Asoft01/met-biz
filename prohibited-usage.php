                ...
                <div class='col-lg-8 worldwide-cols degree-info-accordion'>
                            ...
                            <div class="categories-select">
                                <form action="#" method="POST" id="term-select-nav">
                                    <select class="terms-category form-control" name="terms-category" onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);">
                                        ...
                                        <option value="<?php echo ROOT_DIR; ?>prohibited-usage.php" selected="selected">Prohibited Usage</option>
                    ...
                    <div class="terms-content">
                        <div class="wpb_wrapper">
                            ...
                            <p>You also agree:</p>
                            <ul>
                                <li>Not to reproduce, duplicate a copy or re-sell any part of our site in contravention of the provisions of our terms of website use.</li>
                                <li>Not to access without authority, interfere with, damage or disrupt the following:
                                    <ul>
