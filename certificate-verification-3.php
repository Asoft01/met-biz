...
<div class="main-content">
    <div class="certificate-verification">
        <div class="container">
            <div class="row">
                <div class="col-md-6 mr-auto worldwide-cols mb-2">
                    <div class="steps-button">
                        <div class="card verification-card">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="sample-certify">
                                            <img src="<?php echo ROOT_DIR; ?>images/sample.jpg" class="img-fluid" />
                                        </div>
                                        <div class="sample-certify-text">
                                            <p class="text"><a href="">View Certificate</a></p>
                                        </div>
                                        <button class="btn btn-dark btn-block">Download Course Transcript</button>
                                    </div>
                                </div>
                            </div>
                        </div>
