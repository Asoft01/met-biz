...
<!-- <div class='jumbotron degree-banner' style="background-image: url(images/banners/short-course-landing.jpg);">
    ...
    <div class="container">
        <div class="overlay-text">
            <h1>Professional Certificate Courses in Nigeria</h1>
        </div>
    </div>
</div> -->
       ...
       <div class="container-fluid content-flex px-66">
           <div class="heading-info">
                <h1 class="heading-x-large">
                    <span>Professional Certificate Courses in Business Adminstration</span>
                </h1>
            </div>
        </div>
    </div>
    <div class="split-two-side" style="background-image:url(images/banners/short-course-landing.jpg);"></div>
</div>
                    ...
                    <div class='degree-details'>
                        <div class="row pay-program">
                            ...
                            <div class="col-lg-12 mb-5">
                                <span class="pay-price-discount"><img src="<?php echo ROOT_DIR; ?>images/icons/discount.svg" class="img-fluid discount-icon" /> <span class="x-price">&pound;5,000</span> &pound;2,500</span> <button class="btn btn-dark btn-lg btn-width-sm margin-right-lg-1 margin-top-sm-1">Enroll Now</button><button class="btn btn-outline-danger btn-lg btn-width-sm margin-top-sm-1">Add to Cart</button>
                            </div>
        ...
        <div class="find course-list-msbm main-thumbnail-view py-3 font-fam">
            <div class="container-fluid px-66">
                ...
                <div class="text-center">
                    <button class="btn btn-normal">View more on Professional Certificate Course in Nigeria <i class="fa fa-chevron-right slide-icon"></i></button>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 mx-auto">
                    <div class="action-buttons-dual-btn">
                        <div class="row">
                            <div class="col-lg-6">
                                 <button class='btn btn-link mb-2 btn-block'>Enroll Now</button>
                            </div>
                             <div class="col-lg-6">
                                 <button class='btn btn-outline-danger mb-2 btn-block'>Add to Cart</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-8 mx-auto">
                    <div class="action-buttons-dual-btn">
                        <div class="row">
                            <div class="col-lg-6">
                                 <button class='btn btn-dark mb-2 btn-block'>Enroll Now</button>
                            </div>
                             <div class="col-lg-6">
                                 <button class='btn btn-outline-danger mb-2 btn-block'>Add to Cart</button>
                            </div>
                ...
                <div class="landing-pos">
                    ...
                    <div class="col-lg-6">
                        <div class="landing-video-features tpadd">
                            ...
                            <!-- <div class="media">
                                <img src="<?php echo ROOT_DIR; ?>images/banners/linkedin.png" class="mr-3 landing-video-img" alt="...">
                                <div class="media-body">
                                    <h5 class="mt-0 landing-video-heading">Share your certificate</h5>
                                    Learn how to share your certificate on LinkedIn by clicking <a href="<?php echo ROOT_DIR; ?>how-to-add-your-msbm-certifi" class="text-dark make-bold">here</a>
                                </div>
                            </div> -->
                            <div class="media">
                                <img src="<?php echo ROOT_DIR; ?>images/banners/paper-plane.png" class="mr-3 landing-video-img" alt="...">
                                <div class="media-body">
                                    <h5 class="mt-0 landing-video-heading">Share your certificate</h5>
                                    Learn how to share your certificate on LinkedIn by clicking <a href="<?php echo ROOT_DIR; ?>how-to-add-your-msbm-certificate-to-your-linkedin-profile.php" class="text-dark make-bold">here</a>
                                </div>
                            </div>
                             <!-- <div class="media">
                                <img src="<?php echo ROOT_DIR; ?>images/banners/share-2.png" class="mr-3 landing-video-img" alt="...">
                                <div class="media-body">
                                    <h5 class="mt-0 landing-video-heading">Share your certificate</h5>
                                    Learn how to share your certificate on LinkedIn by clicking <a href="<?php echo ROOT_DIR; ?>how-to-add-your-msbm-certificate-to-your-linkedin-profile.php" class="text-dark make-bold">here</a>
                                </div>
                             ...
                             <!-- <div class="media">
                                <img src="<?php echo ROOT_DIR; ?>images/banners/linkedin-2.png" class="mr-3 landing-video-img" alt="...">
                                <div class="media-body">
                                    <h5 class="mt-0 landing-video-heading">Share your certificate</h5>
                                    Learn how to share your certificate on LinkedIn by clicking <a href="" class="text-dark make-bold">here</a>
                                </div>
                            </div> -->
                        </div>
                    </div>
...
<div class="find course-list-msbm main-thumbnail-view py-5 font-fam">
    <div class="container-fluid px-66">
        <p class="heading-find">See other related Professional Certificate Courses</p>
        <div class="row myflex">
            <div class="col-md-6 col-10 col-lg-6 col-xl-3 card">
                <a href="" class="card-ahref-flex">
                    <div class="card-img-wrap">
...
<div class="view-sug-cat-sect pb-5">
    <div class="container-fluid">
        <h4 class="make-bold text-center mb-3">See other suggested courses you might be interested in</h4>
        <div class="row">
            <div class="col-lg-12">
                <ul class="list-unstyled d-flex flex-wrap justify-content-center align-items-center">
                    <li><a href="<?php echo ROOT_DIR; ?>" class="sub-btn-pill bord-rad-50"> MS Programme in Human Resource Management - HRM 2021</a></li>
                    <li><a href="<?php echo ROOT_DIR; ?>" class="sub-btn-pill bord-rad-50"> MA Programme in Human Resource Management - HRM 2021</a></li>
                    <li><a href="<?php echo ROOT_DIR; ?>" class="sub-btn-pill bord-rad-50"> MSc Programme in Human Resource Management - HRM 2021</a></li>
                    <li><a href="<?php echo ROOT_DIR; ?>" class="sub-btn-pill bord-rad-50"> Masters Programme in Human Resource Management - HRM 2021</a></li>
                    <li><a href="<?php echo ROOT_DIR; ?>" class="sub-btn-pill bord-rad-50"> Degree Programme in Human Resource Management - HRM 2021</a></li>
                    <li><a href="<?php echo ROOT_DIR; ?>" class="sub-btn-pill bord-rad-50"> Bachelors of Human Resource Management - HRM 2021</a></li>
                    <li><a href="<?php echo ROOT_DIR; ?>" class="sub-btn-pill bord-rad-50"> BA Programme in Human Resource Management - HRM 2021</a></li>
                    <li><a href="<?php echo ROOT_DIR; ?>" class="sub-btn-pill bord-rad-50"> BAA Programme in Human Resource Management - HRM 2021</a></li>
                    <li><a href="<?php echo ROOT_DIR; ?>" class="sub-btn-pill bord-rad-50"> BSc Programme in Human Resource Management - HRM 2021</a></li>
                    <li><a href="<?php echo ROOT_DIR; ?>" class="sub-btn-pill bord-rad-50"> Masters Programme in Human Resource Management - HRM 2021</a></li>
                    <li><a href="<?php echo ROOT_DIR; ?>" class="sub-btn-pill bord-rad-50"> Diploma Programme in Human Resource Management - HRM 2021</a></li>
                    <li><a href="<?php echo ROOT_DIR; ?>" class="sub-btn-pill bord-rad-50"> Extended Diploma Programme in Human Resource Management - HRM 2021</a></li>
                </ul>
            </div>
        </div>
    </div>
