...
<body>
    ...
    <div class="student_portal">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h2><strong>Duplicate Template</strong></h2>
                </div>
            </div>
                                ...
                                <div class="light-card">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <p class="text-center">
                                                <a href="<?php echo ROOT_DIR; ?>staff/admin-automated-emails-from-staff.php"><i class="fa fa-chevron-left"></i> Back to Template List</a>
                                            </p>
                                        </div>
                                    </div>
                                </div>
