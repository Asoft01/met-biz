                ...
                <div class="col-lg-9 statistics">
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-6 col-xl-6 admin-stat">
                            <a href="#">
                                <div class="card gradient-darken">
                                    <div class="card-body">
                                        <div class="media align-items-center">
                                            <div class="media-body">
                                                <p class="text-white">First Bank (No of Staff)</p>
                                                <h4 class="text-white line-height-5">45</h4>
                                            </div>

                                            <img src="../images/White-Logo-1.svg" width="80">
                                        </div>
                                    </div>
                                </div>
                            </a>
                            ...
                            <a href="#">
                                <div class="card gradient-darken">
                                    <div class="card-body">
                                        <div class="media align-items-center">
                                            <div class="media-body">
                                                <p class="text-white">Oando (No of Staff)</p>
                                                <h4 class="text-white line-height-5">45</h4>
                                            </div>
                                            <img src="../images/White-Logo-1.svg" width="80">
                                        </div>
                            ...
                            <a href="#">
                                <div class="card gradient-darken">
                                    <div class="card-body">
                                        <div class="media align-items-center">
                                            <div class="media-body">
                                                <p class="text-white">Dangote (No of Staff)</p>
                                                <h4 class="text-white line-height-5">45</h4>
                                            </div>
                                            <img src="../images/White-Logo-1.svg" width="80">
                                        </div>
                            ...
                            <a href="#">
                                <div class="card gradient-darken">
                                    <div class="card-body">
                                        <div class="media align-items-center">
                                            <div class="media-body">
                                                <p class="text-white">FCMB (No of Staff)</p>
                                                <h4 class="text-white line-height-5">45</h4>
                                            </div>
                                            <img src="../images/White-Logo-1.svg" width="80">
                                        </div>
