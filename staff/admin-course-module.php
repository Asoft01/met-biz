...
<body>
    ...
    <div class="student_portal">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h2><strong>Module Settings</strong></h2>
                    ...
                    <div class="admin-staff-container">
                        <form>
                                ...
                                <table class="table table-striped assignment-table-info table-scrollable">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo ROOT_DIR; ?>staff/admin-module-component.php" class="btn btn-secondary btn-sm text-white"><i class="fa fa-volume-up"></i> 12</a>
                                            </td>
                                            <td>
                                                <a href="<?php echo ROOT_DIR; ?>staff/admin-module-material.php" class="btn btn-info btn-sm text-white"><i class="fa fa-book"></i> 10</a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>2</th>
                            ...
                            <div class="form-group text-center">
                                <button class="btn btn-dark">Assign Modules to branches</button>
                            </div>
                        </form>
