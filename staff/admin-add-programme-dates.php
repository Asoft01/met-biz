    ...
    <body>
        ...
        <div class="student_portal">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <h2><strong>Add Programme Dates</strong></h2>
                    </div>
                </div>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <form>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="eg N35,000 or $4,000" />
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Discount</label>
                                                        <input type="text" class="form-control" value="" placeholder="eg N50,000 or $3,000" />
                                                    </div>
                                                    <div class="form-group">
