...
<body>
    ...
    <div class="student_portal">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h2><strong>Edit Staff</strong></h2>
                        ...
                        <div class="row">
                            <div class="col-lg-8 mx-auto">
                                <div class="light-card">
                                    <div class="card">
                                        <div class="card-body">
                                            <form action="<?php echo ROOT_DIR; ?>staff/admin-edit-staff.php" method="post">
                                                ...
                                                <div class="form-group">
                                                    <button class="btn btn-dark btn-block" type="submit">Update User</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
