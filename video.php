...
<div class="video-main-container">
    ...
    <!-- <video class="main-video-view" playsinline webkit-playsinline width="100%" height="100%" autoplay="autoplay" loop="" muted="" poster="images/banners/video-poster.png">
        <source src="<?php echo ROOT_DIR; ?>video/test2.mp4" type="video/mp4">
    </video> -->
     <video onloadedmetadata="this.muted = true" autoplay="autoplay" muted="muted" loop="loop" playsinline="playsinline" class="main-video-view" width="100%" height="100%" poster="images/banners/video-poster.png">
        <source src="<?php echo ROOT_DIR; ?>video/test2.mp4" type="video/mp4">
