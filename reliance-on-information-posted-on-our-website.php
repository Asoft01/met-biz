        ...
        <div class="container">
            <div class='row '>
                <div class='col-lg-8 worldwide-cols degree-info-accordion'>
                    <h3>Reliance on Information posted on our website</h3>
                            ...
                            <div class="categories-select">
                                <form action="#" method="POST" id="term-select-nav">
                                    <select class="terms-category form-control" name="terms-category" onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);">
                                        ...
                                        <option value="<?php echo ROOT_DIR; ?>reliance-on-information-posted-on-our-website.php" selected="selected">Reliance on Information posted on our website</option>
                    ...
                    <div class="terms-content">
                        <div class="wpb_wrapper">
                            <p>Commentary, details and other materials posted on our site are not intended to amount to advice on which reliance should be placed. We therefore disclaim all liability and responsibility arising from any reliance placed on such materials by any visitor to our site, or by anyone who may be informed of any of its contents. </p>
                            <p>Specifically, course and registration information is dynamic and subject to change; the most up-to-date and complete information is the one we provide to prospective students at the point of registration, and this may differ from time to time so there is need to check for updated information from time to time on our website.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
