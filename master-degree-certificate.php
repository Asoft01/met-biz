        ...
        <div class="container">
            <div class='row '>
                <div class='col-lg-8 worldwide-cols degree-info-accordion'>
                    ...
                    <h3>Master Degree Certificate</h3>
                    <p class="text-center"> <img src="<?php echo ROOT_DIR; ?>images/banners/MA HRM sample Certificate.jpg" class="mr-3 certificate-img-samp" alt="..."></p>
                    <p>Our Master Degree Certificates are awarded by our affiliate UK Universities.</p>
                    <p>These Certificates are awarded after the successful completion of our Master Degree Top-up with our affiliate UK Universities which usually involves the thesis writing for 1 to 3 Modules.</p>
                    <p>The Academic Credit for this Certificate is 60 and in addition with the Level 7 Diploma Course registered for, becomes a total of 180.</p>
                </div>
                <div class="col-lg-4">
