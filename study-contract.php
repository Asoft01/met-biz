            ...
            <div class='row '>
                <div class='col-lg-8 worldwide-cols degree-info-accordion'>
                    ...
                    <div class="terms-content">
                        ...
                        <h4 class="terms-content-heading">Academic headquarters</h4>
                        <p>Metropolitan School of Business & Management, UK is registered company registered in England and Wales under company number 9716902 and located at: Floor 37, One Canada Square, E14 5DY, Canary Wharf, London, United Kingdom. </p>
                        <h4 class="terms-content-heading">Administrative Headquarters</h4>
                        ...
                        <p>The MSBM Administrative Headquarters is in charge of all Student Fee Collection and thus all base Fees are in United Arab Emirates (UAE) Dirhams.
                        VAT Registration Number is 100276012000003 under the name: Metropolitan School of Business & Management FZE.</p>
                        <p>These two companies will be referred to as (“we”, “us” and “our”). </p>
                        <p>If you would like to contact us, we can be reached by email on <a href="mailto:info@msbm.org.uk">info@msbm.org.uk</a>.</p>
                        <h4 class="terms-content-heading">Definitions and Contract</h4>
                        <p>In these terms and conditions, the following definitions apply to the Contract you have with us: </p>
                        <h4 class="terms-content-heading">Commencement Date</h4> <p>The date on which the Course or Training Commences.</p>
                        <h4 class="terms-content-heading">Contract</h4>
                        ...
                        <h4 class="terms-content-heading">Course/Training/Programme</h4>
                        ...
                        <h4 class="terms-content-heading">Sponsor</h4>
                        <p>Any third party which may pay your tuition fees.</p>
                        <h4 class="terms-content-heading">Tuition Fees:</h4>
                        ...
                        <h4 class="terms-content-heading">‘We’, ‘Us’ and ‘Our’</h4>
                        ...
                        <h4 class="terms-content-heading">Fees</h4>
                        ...
                        <p>You will either be directed to a Payment page on our website or be manually sent an invoice for your Fees which you must pay according to the terms stated in your invoice, payment page and this Terms and Conditions.
                        We will accept payment of Your Fees by a Sponsor but will consider you to be responsible, and therefore liable, for Your Fees. We may withdraw your place and terminate the contract between you and us if you or your Sponsor fails to pay your Fees by the required deadline.</p>
                        <h4 class="terms-content-heading">Cancellations & Deferrals</h4>
                        ...
                        <h4 class="terms-content-heading">Your Responsibilities</h4>
                        ...
                        <h4 class="terms-content-heading">Our Responsibilities</h4>
                        <p> Save for the reasons set out above, We will use our best endeavours to deliver the Course/Training/Programme to you as it is set out on our Website or Off-the-shelf Brochures.
                        We will grant you access to academic services, including the use of our I.T facilities if applicable.</p>
                        ...
                        <p>We will comply with all relevant legislation, which includes the Data Protection Act 1998, which is reflected in <span class="text-danger">Our Data Protection Policy Liability</span>.</p>
                        ...
                        <p>You will be liable for any damage or loss which we incur as a result of any unlawful, negligent, unreasonable or unwarranted action, behaviour, omission or decision on your part.
                        You will be liable for the payment of your fees by the specified deadline in your fee invoice.</p>
                        <h4 class="terms-content-heading">Intellectual Property</h4>
                        ...
                        <h4 class="terms-content-heading">Personal Information</h4>
                        <p> We will comply with the Data Protection Act 1998. Unless You inform Us otherwise: We will retain Your personal information to contact You with marketing information and other School-related information that We would normally send to Our alumni; We will ask You to complete anonymous evaluation surveys at the end of Your Programme, the results of which We will circulate to relevant members in the School and externally for marketing purposes only Unless You write to Us to tell Us otherwise, We will use video and photographic images of Your Programme for promotional campaigns and engage with the wider community.</p>
                         <h4 class="terms-content-heading">Enforcement and Termination</h4>
                        ...
                        <h4 class="terms-content-heading">Other Terms</h4>
                        ...
                        <h4 class="terms-content-heading">Courses/Trainings/Programmes Descriptions</h4>
                        <p>The images of the Courses/Training/Programmes on our website are for illustrative purposes only.</p>
                        <h4 class="terms-content-heading">Fees and Delivery</h4>
                        ...
                        <p>The fees quoted for the Courses/Training/Programmes on our website do not include VAT.
                        Though the Fee payable may be displayed in your local currency, the base Fee is in the United Arab Emirates (UAE) Dirhams and payments are collected in the UAE Dirhams.  The total amount due will be confirmed on the payment page or the manually sent Invoice for payment.</p>
                        ...
                        <h4 class="terms-content-heading">Ownership of the Metropolitan School of Business and Management UK</h4>
                        <p>Course/Training/Programmes you have registered for will only pass to you when we have received the Installment or full payment, from you. However, once you have been given access to the Metropolitan School of Business and Management UK Course/ Training/ Programmes you have registered for, they are your responsibility.  The Metropolitan School of Business and Management UK Course/Training/Programmes are held at your risk from the time of access or commencement of the Course/Training/Programme.</p>
                        ...
                        <p>Delivery fees for an off-the-shelf customized Metropolitan School of Business and Management UK Course/Training/Programmes not listed on our website will be made available to you before an Invoice is sent on request.  The exact delivery time for the Course/ Training/Programme will also be outlined in the Proposal sent to you.</p>
                         <h4 class="terms-content-heading">Disclaimer</h4>
                        ...
                        <h4 class="terms-content-heading">Confirmations</h4>
