    ...
    <div class="under-maintenance-sect">
        <div class="not-found-container">
            <div class="not-found-text">
                ...
                <p>We're currently working on our site, we are sorry for the inconvenience please check back later.<br /> If you need any form of assistance, tell us at support@msbm.org.uk.</p>
            </div>
        </div>
    </div>
