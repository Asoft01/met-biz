...
<div class="main-landing-page nigeria">
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <div class="landing-position">
                        <h1 class="mba-header"><strong>Bachelor's Degree</strong></h1>
                        <span>The Bachelor's degree courses are dual qualifications consisting of Level 4 & 5 Diploma (OFQUAL certificates) + Top-up programme awarded by partner universities. These programmes are a total of 540 credits.</span>
                    </div>
                </div>
            ...
            <div class="landing-features-content">
                ...
                <div class="row text-center">
                    ...
                    <div class='col-lg-3'>
                        ...
                        <p class="text">Dual Qualifications</p>
                    ...
                    <div class='col-lg-3'>
                        ...
                        <p class="text">Final Semester in the UK</p>
                        <p class='sub-text'>Undergo your final semester in the UK.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="landing-certificate why_msbm">
        <div class="container">
            ...
            <!-- <p class="text-center">Level 4/5 Diploma + BA</p> -->
            <div class="row">
                <div class="landing-pos">
                    <div class="col-lg-5">
                        <p class="text-center"> <img src="<?php echo ROOT_DIR; ?>images/banners/lEVEL 5 Sample Certificate.jpg" class="mr-3 img-certify" alt="..."></p>
                    </div>
                    ...
                    <div class="col-lg-5">
                        <p class="text-center"> <img src="<?php echo ROOT_DIR; ?>images/banners/BSC Sample Certificate.jpg" class="mr-3 img-certify" alt="..."></p>
                    </div>
                ...
                <div class="row text-center">
                    <div class="col-lg-4">
                        <div class="user-testify">
                            <img src="<?php echo ROOT_DIR; ?>images/banners/Portrait_Placeholder.png" class="mr-3 img-fluid rounded-circle img-testify" alt="...">
                            <p>
