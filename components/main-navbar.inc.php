         ...
         <div class="collapse navbar-collapse" id="navbarNavDropdown">
             ...
             <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown sign_in btn-transparent add-relative btn-sign-in-adjust d-none d-lg-block d-xl-block">
                    <a class="nav-link dropdown-toggle course-folder" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                 ...
                 <li class="nav-item d-none d-lg-block d-xl-block sign_in register_now btn-sign-in-adjust"><a href="https://portal.msbm.org.uk/user/access" class="nav-link sign-btn">Log In</a></li>
                 <li class="nav-item d-none d-lg-block d-xl-block sign_in btn-sign-in-adjust"><a href="https://portal.msbm.org.uk/user/register" class="nav-link sign-btn">Join for free</a></li>
             </ul>
