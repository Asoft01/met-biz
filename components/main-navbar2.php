...
<div class="location bg-lighter-1 top-location-sect">
 ...
 <nav class="navbar navbar-expand-lg navbar pro-sticky-top bg-white navigator navbar-main-container">
     <div class="container-fluid px-66">
         <a class="navbar-brand mr-3" href="#"><img src="<?php echo ROOT_DIR; ?>images/banners/logo-dark.png" width="100"></a>
         <ul class="navbar-nav ml-auto d-flex flex-row align-items-center">
               <li class="nav-item sign_in btn-transparent add-relative btn-sign-in-adjust d-lg-none d-xl-none rmv-rpadding">
                    <a href="<?php echo ROOT_DIR; ?>cart.php" class="nav-link sign-btn text-black"><i class="fa fa-folder-open fa-lg"></i></a>
                    <span class="count-wish">1</span>
                </li>
                <li class="nav-item d-lg-none d-xl-none mx-2"><a href="<?php echo ROOT_DIR; ?>student/login.php" class="nav-link sign-btn text-dark font-xs fw-600 mb-2">Join for free</a></li>
         </ul>
         ...
         <div class="collapse navbar-collapse" id="navbarNavDropdown">
             <ul class="navbar-nav nav-height-fix navbar-link-container">
                 <li class="nav-item dropdown navigator-dropdown has-mega-menu" style="position:static;">
                     <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Courses <img src="<?php echo ROOT_DIR; ?>images/icons/downwards-pointer.svg" class="flipnav arrow-nav ml-1 apply-filter-invert-1"></a>
                             ...
                             <div class="row">
                                 <div class="col-md-8 ">
                                     <div class="cols-count-nav">
                                        <a class="dropdown-item nav-dropdown-item-link" href="<?php echo ROOT_DIR; ?>business-management.php">
                                            <img src="<?php echo ROOT_DIR; ?>images/icons/work.svg" class="img-fluid mr-2" width="30">
                                            <span class="nav-text-wrap">Business Management</span>
                                        </a>
                                        <a class="dropdown-item nav-dropdown-item-link" href="<?php echo ROOT_DIR; ?>health-and-psychology.php">
                                            <img src="<?php echo ROOT_DIR; ?>images/icons/heart.svg" class="img-fluid mr-2" width="30">
                                            <span class="nav-text-wrap">Health and Psychology</span>
                                        </a>
                                        <a class="dropdown-item nav-dropdown-item-link" href="<?php echo ROOT_DIR; ?>business-law.php">
                                            <img src="<?php echo ROOT_DIR; ?>images/icons/law.svg" class="img-fluid mr-2" width="30">
                                            <span class="nav-text-wrap">Business Law</span>
                                        </a>
                                        <a class="dropdown-item nav-dropdown-item-link" href="<?php echo ROOT_DIR; ?>information-technology.php">
                                            <img src="<?php echo ROOT_DIR; ?>images/icons/idea.svg" class="img-fluid mr-2" width="30">
                                            <span class="nav-text-wrap">IT</span>
                                        </a>
                                        <a class="dropdown-item nav-dropdown-item-link" href="<?php echo ROOT_DIR; ?>personal-development.php">
                                            <img src="<?php echo ROOT_DIR; ?>images/icons/progress.svg" class="img-fluid mr-2" width="30">
                                            <span class="nav-text-wrap">Personal Development</span>
                                        </a>
                                        <a class="dropdown-item nav-dropdown-item-link" href="<?php echo ROOT_DIR; ?>teaching-and-education.php">
                                            <img src="<?php echo ROOT_DIR; ?>images/icons/mortarboard.svg" class="img-fluid mr-2" width="30">
                                            <span class="nav-text-wrap">Teaching and Education</span>
                                        </a>
                                        <a class="dropdown-item nav-dropdown-item-link" href="<?php echo ROOT_DIR; ?>health-and-safety.php">
                                            <img src="<?php echo ROOT_DIR; ?>images/icons/medicine.svg" class="img-fluid mr-2" width="30">
                                            <span class="nav-text-wrap">Health and Safety</span>
                                        </a>
                                        <a class="dropdown-item nav-dropdown-item-link" href="<?php echo ROOT_DIR; ?>finance-and-accounting.php">
                                            <img src="<?php echo ROOT_DIR; ?>images/icons/money.svg" class="img-fluid mr-2" width="30">
                                            <span class="nav-text-wrap">Finance and Accounting</span>
                                        </a>
                                        <a class="dropdown-item nav-dropdown-item-link" href="<?php echo ROOT_DIR; ?>office-productivity.php">
                                            <img src="<?php echo ROOT_DIR; ?>images/icons/files-and-folders.svg" class="img-fluid mr-2" width="30">
                                            <span class="nav-text-wrap">Office Productivity</span>
                                        </a>
                                        <a class="dropdown-item nav-dropdown-item-link" href="<?php echo ROOT_DIR; ?>sale-and-marketing.php">
                                            <img src="<?php echo ROOT_DIR; ?>images/icons/sale.svg" class="img-fluid mr-2" width="30">
                                            <span class="nav-text-wrap">Sales and Marketing</span>
                                        </a>
                                        <a class="dropdown-item nav-dropdown-item-link" href="<?php echo ROOT_DIR; ?>leadership-and-entrepreneurship.php">
                                            <img src="<?php echo ROOT_DIR; ?>images/icons/leadership.svg" class="img-fluid mr-2" width="30">
                                            <span class="nav-text-wrap">Leadership and Entrepreurship</span>
                                        </a>
                                        <a class="dropdown-item nav-dropdown-item-link" href="<?php echo ROOT_DIR; ?>human-resources.php">
                                            <img src="<?php echo ROOT_DIR; ?>images/icons/search.svg" class="img-fluid mr-2" width="30">
                                            <span class="nav-text-wrap">Human Resources</span>
                                        </a>
                                        <a class="dropdown-item nav-dropdown-item-link" href="<?php echo ROOT_DIR; ?>">
                                            <img src="<?php echo ROOT_DIR; ?>images/icons/Hotel-Travel-and-Hospitality-Management.svg" class="img-fluid mr-2" width="30">
                                            <span class="nav-text-wrap">Hotel, Travel and Hospitality Management</span>
                                        </a>
                                        <a class="dropdown-item nav-dropdown-item-link" href="<?php echo ROOT_DIR; ?>">
                                            <img src="<?php echo ROOT_DIR; ?>images/icons/Logistics-and Supply-Chain-Management.svg" class="img-fluid mr-2" width="30">
                                            <span class="nav-text-wrap">Logistics and Supply Chain Management</span>
                                        </a>
                                     </div>
                                 </div>
                                 <div class="col-md-4">
                 ...
                 <li class="nav-item dropdown has-mega-menu programme-category-item" style="position:static;">
                     <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Category <img src="<?php echo ROOT_DIR; ?>images/icons/downwards-pointer.svg" class="flipnav arrow-nav ml-1 apply-filter-invert-1"></a>
                 ...
                 <li class="nav-item dropdown has-mega-menu" style="position:static;">
                     <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Trainings <img src="<?php echo ROOT_DIR; ?>images/icons/downwards-pointer.svg" class="flipnav arrow-nav ml-1 apply-filter-invert-1"></a>
                     <div class="dropdown-menu" style="width:100%">
                         <div class="px-0 container">
             ...
             <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown sign_in btn-transparent add-relative btn-sign-in-adjust d-none d-lg-block d-xl-block">
                    <a class="nav-link dropdown-toggle course-folder text-black" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <i class="fa fa-folder-open fa-lg"></i> <span class="ml-2 cart-nav-text fw-600">Course Folder</span></a><span class="count-wish">10</span>
                    </a>
                 ...
                 <li class="nav-item d-none d-lg-block d-xl-block btn-sign-in-adjust font-xs"><a href="https://portal.msbm.org.uk/user/access" class="nav-link sign-btn text-black fw-600">Log In</a></li>
                 <li class="nav-item d-none d-lg-block d-xl-block btn-sign-in-adjust font-xs"><a href="https://portal.msbm.org.uk/user/register" class="nav-link sign-btn text-black fw-600">Join for free</a></li>
             </ul>
