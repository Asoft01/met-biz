            ...
            <div class='row '>
                <div class='col-lg-8 mx-auto about-msbm'>
                    ...
                    <div class="terms-content">
                        <h3 class="terms-content-heading">Our Vision</h3>
                        <div class="wpb_wrapper">
                            <p>Our Vision is to impact 200,000 students with a quality, premium and affordable British Education annually.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
