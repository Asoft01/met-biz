...
<div class='jumbotron degree-banner' style="background-image: url(images/banners/open-programme.jpg);">
    <div class='overlay'></div>
    <div class="container">
        <div class="overlay-text">
            <h1>Boredom-busting courses</h1>
            <p>Trying to improve your skills this coronavirus lockdown? Try out an online course to learn a new language, or even upgrade career.</p>
        </div>
    </div>
</div>
...
<div class="main-content">
    <!-- <div class="short-all-courses">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <a href="" class="card-ahref-flexx">
                        <div class="card mb-3">
                            <div class="row no-gutters landscape-card">
                                <div class="col-md-6">
                                    <img src="<?php echo ROOT_DIR; ?>images/bsc-london.jpg" class="card-img short-all-img" alt="...">
                                </div>
                                <div class="col-md-6 short-course-overview">
                                    <div class="card-body business-content">
                                        <small>Coventry University</small>
                                        <h4 class="card-title">BA in International Business (Top up)</h5>
                                            <p class="card-text bus short-text-course">Lorem ipsum dolor sit amet consectetur adipisicing elit. Libero praesentium neque fugit necessitatibus officiis dicta aliquam minima similique suscipit laboriosam dolorum eum ut aut, aperiam.</p>
                                            <div class="btn-btn-holder">
                                                <button class="btn btn-dark btn-block mt-0">Find out more</button>
                                            </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-md-6">
                    <a href="" class="card-ahref-flexx">
                        <div class="card mb-3">
                            <div class="row no-gutters landscape-card">
                                <div class="col-md-6">
                                    <img src="<?php echo ROOT_DIR; ?>images/dubai-mba.jpg" class="card-img short-all-img" alt="...">
                                </div>
                                <div class="col-md-6 short-course-overview">
                                    <div class="card-body business-content">
                                        <small>Coventry University</small>
    ...
    <div class="find course-list-msbm">
        <div class="container">
            <p class="heading-find">Start a free taster course</p>
            ...
            <!-- <div class="text-center">
                <button class="btn btn-normal">View all courses in January <i class="fa fa-chevron-right slide-icon"></i></button>
            </div> -->
        </div>
    </div>
</div>
