...
<div id="main">
    ...
    <div class="content-section">
        <h2 class="text-center">Level 5 Diploma Certificate Page</h2>
                        ...
                        <div class='row '>
                            <div class='col-lg-12 mx-auto about-msbm'>
                                <div class="terms-content">
                                    <h3>Level 5 Diploma Certificate</h3>
                                    <p class="text-center"> <img src="../images/banners/lEVEL 5 Sample Certificate.jpg" class="mr-3 certificate-img-samp" alt="..."></p>
                                    <p>Our Level 5 Diploma Certificate is our Undergraduate (Year 2) Certificate that falls under the European Qualifications Framework (EQF) Level 5.</p>
