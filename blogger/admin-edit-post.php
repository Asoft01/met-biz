   ...
   <body>
       ...
       <div class="main-content pad-50">
           <div class="post-list-sect p-100">
               <div class="container">
                   <h2 class="make-bold mb-3">Edit Post</h2>
                   <div class="alert alert-warning letter-space text-uppercase ft-12p" role="alert">
                       You have successfully updated your content.
                   </div>
                   <form>
                       <div class="row">
                           <div class="col-lg-7">
                                   ...
                                   <div class="card mb-3">
                                       ...
                                       <div class="card-body">
                                           ...
                                           <div class="d-flex flex-wrap">
                                               <button type="button" class="btn btn-success letter-space text-uppercase ft-12p mr-1 mb-2" data-toggle="tooltip" data-placement="top" title="Publish Post">Publish</button>
                                   ...
                                   <div class="card mb-3">
                                       ...
                                       <div class="card-body">
                                           ...
                                           <div class="mt-4">
                                               ...
                                               <button class="btn btn-red btn-block btn-sm new-cat letter-space text-uppercase ft-12p" href="<?php echo ROOT_DIR; ?>categories.php"><i class="fa fa-plus"></i> Add New Category</button>
                                           </div>
                                       </div>
                                   </div>
                                   ...
                                   <div class="card mb-3">
                                       ...
                                       <div class="card-body">
                                           <div class="img-box-container">
                                               <img src="<?php echo ROOT_DIR; ?>images/banner.jpg" class="img-fluid ob-fit featured-image-bg" />
                                           </div>
