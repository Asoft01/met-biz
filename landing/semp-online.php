...
<body>
    ...
    <div class="main-landing-page semp-online">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <div class="landing-position">
                            <div>
                                <h1 class="mba-header"><strong>SPECIAL EXECUTIVE MASTERS PROGRAMME</strong></h1>
        ...
        <div class="find available-courses">

            <div class="container">
                <p class="heading-find">Available Courses</p>
                <div class="row myflex">
                    <div class="col-md-6 col-10 col-lg-6 col-xl-3 card">
                        <a href="" class="card-ahref-flex">
                            ...
                            <div class="card-body">
                                ...
                                <h6 class="card-title">SEMP Business Administration (MBA)</h6>
                    ...
                    <div class="col-md-6 col-10 col-lg-6 col-xl-3 card">
                        <a href="" class="card-ahref-flex">
                            ...
                            <div class="card-body">
                                <p class="card-text card-uni">UK Partner University</p>
                                <h6 class="card-title">SEMP Business Management (MBM)</h6>
                                <p class="desc">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Lorem, ipsum dolor sit amet consectetur adipisicing elit.</p>
                                <div class="row">
                                    <div class="col-5 mb-2">
                                        <p class="card-text"><img src="<?php echo ROOT_DIR; ?>images/icons/hour-glass.svg" class="desc-icon"> 2 Weeks</p>
                    ...
                    <div class="col-md-6 col-10 col-lg-6 col-xl-3 card">
                        <a href="" class="card-ahref-flex">
                            ...
                            <div class="card-body">
                                <p class="card-text card-uni">UK Partner University</p>
                                <h6 class="card-title">SEMP Business Enterprise Software</h6>
                    ...
                    <div class="col-md-6 col-10 col-lg-6 col-xl-3 card">
                        <a href="" class="card-ahref-flex">
                            ...
                            <div class="card-body">
                                <p class="card-text card-uni">UK Partner University</p>
                                <h6 class="card-title">SEMP Information Management</h6>
                    ...
                    <div class="col-md-6 col-10 col-lg-6 col-xl-3 card">
                        <a href="" class="card-ahref-flex">
                            ...
                            <div class="card-body">
                                <p class="card-text card-uni">UK Partner University</p>
                                <h6 class="card-title">SEMP Information Systems</h6>
                                <p class="desc">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Lorem, ipsum dolor sit amet consectetur adipisicing elit.</p>
                                <div class="row">
                                    <div class="col-5 mb-2">
                                        <p class="card-text"><img src="<?php echo ROOT_DIR; ?>images/icons/hour-glass.svg" class="desc-icon"> 2 Weeks</p>
                    ...
                    <div class="col-md-6 col-10 col-lg-6 col-xl-3 card">
                        <a href="" class="card-ahref-flex">
                            ...
                            <div class="card-body">
                                <p class="card-text card-uni">UK Partner University</p>
                                <h6 class="card-title">SEMP<br>Information Technology</h6>
                                <p class="desc">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Lorem, ipsum dolor sit amet consectetur adipisicing elit.</p>
                                <div class="row">
                                    <div class="col-5 mb-2">
                                        <p class="card-text"><img src="<?php echo ROOT_DIR; ?>images/icons/hour-glass.svg" class="desc-icon"> 2 Weeks</p>
                    ...
                    <div class="col-md-6 col-10 col-lg-6 col-xl-3 card">
                        <a href="" class="card-ahref-flex">
                            ...
                            <div class="card-body">
                                <p class="card-text card-uni">UK Partner University</p>
                                <h6 class="card-title">SEMP Operations Management</h6>
                                <p class="desc">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Lorem, ipsum dolor sit amet consectetur adipisicing elit. Lorem, ipsum dolor sit amet consectetur adipisicing elit. </p>
                                <div class="row">
                                    <div class="col-5 mb-2">
                                        <p class="card-text"><img src="<?php echo ROOT_DIR; ?>images/icons/hour-glass.svg" class="desc-icon"> 2 Weeks</p>
                    ...
                    <div class="col-md-6 col-10 col-lg-6 col-xl-3 card">
                        <a href="" class="card-ahref-flex">
                            ...
                            <div class="card-body">
                                <p class="card-text card-uni">UK Partner University</p>
                                <h6 class="card-title">SEMP International Marketing</h6>
                                <p class="desc">Lorem, ipsum dolor sit amet consectetur adipisicing elit. </p>
                                <div class="row">
                                    <div class="col-5 mb-2">
                                        <p class="card-text"><img src="<?php echo ROOT_DIR; ?>images/icons/hour-glass.svg" class="desc-icon"> 2 Weeks</p>
                    ...
                    <div class="col-md-6 col-10 col-lg-6 col-xl-3 card">
                        <a href="" class="card-ahref-flex">
                            ...
                            <div class="card-body">
                                <p class="card-text card-uni">UK Partner University</p>
                                <h6 class="card-title">SEMP Human Resource Management</h6>
                                <p class="desc">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Lorem, ipsum dolor sit amet consectetur adipisicing elit.</p>
                                <div class="row">
                                    <div class="col-5 mb-2">
                                        <p class="card-text"><img src="<?php echo ROOT_DIR; ?>images/icons/hour-glass.svg" class="desc-icon"> 2 Weeks</p>
                    ...
                    <div class="col-md-6 col-10 col-lg-6 col-xl-3 card">
                        <a href="" class="card-ahref-flex">
                            ...
                            <div class="card-body">
                                <p class="card-text card-uni">UK Partner University</p>
                                <h6 class="card-title">SEMP Strategic Business Management</h6>
                                <p class="desc">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Lorem, ipsum dolor sit amet consectetur adipisicing elit.</p>
                                <div class="row">
                                    <div class="col-5 mb-2">
                                        <p class="card-text"><img src="<?php echo ROOT_DIR; ?>images/icons/hour-glass.svg" class="desc-icon"> 2 Weeks</p>
                    ...
                    <div class="col-md-6 col-10 col-lg-6 col-xl-3 card">
                        <a href="" class="card-ahref-flex">
                            ...
                            <div class="card-body">
                                <p class="card-text card-uni">UK Partner University</p>
                                <h6 class="card-title">SEMP Financial Management</h6>
                                <p class="desc">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Lorem, ipsum dolor sit amet consectetur adipisicing elit. Lorem, ipsum dolor sit amet consectetur adipisicing elit. </p>
                                <div class="row">
                                    <div class="col-5 mb-2">
                                        <p class="card-text"><img src="<?php echo ROOT_DIR; ?>images/icons/hour-glass.svg" class="desc-icon"> 2 Weeks</p>
                    ...
                    <div class="col-md-6 col-10 col-lg-6 col-xl-3 card">
                        <a href="" class="card-ahref-flex">
                            ...
                            <div class="card-body">
                                <p class="card-text card-uni">UK Partner University</p>
                                <h6 class="card-title">SEMP Project Management</h6>
                                <p class="desc">Lorem, ipsum dolor sit amet consectetur adipisicing elit. </p>
                                <div class="row">
                                    <div class="col-5 mb-2">
                                        <p class="card-text"><img src="<?php echo ROOT_DIR; ?>images/icons/hour-glass.svg" class="desc-icon"> 2 Weeks</p>
            ...
            <div class="container">
                <div class="row">
                    <div class="landing-pos">
                        <div class="col-lg-6">
                            <div class="video-container"><iframe width="560" height="315" src="https://www.youtube.com/embed/bNyidmAyUCE?rel=0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen=""></iframe></div>
                        </div>
                        <div class="col-lg-6">
        ...
        <div class="logo-banner branded landing-brand">
            <div class="container">
                <h5 class="client-heading">PARTICIPANTS OF MSBM'S POSTGRADUATE DIPLOMA PROGRAMME<br /> ARE FROM COMPANIES SUCH AS</h5>
                <div class="row text-center">
                    <!-- <div class="col-md-12">
