...
<body>
    ...
    <div class="main-landing-page semp-it">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <div class="landing-position">
                            <div>
                                <h1 class="mba-header"><strong>SPECIAL EXECUTIVE MASTERS PROGRAMME</strong> in <strong>Information Technology</strong></h1>
                        ...
                        <div class="accordion mb-5" id="msbmAccordion">
                                ...
                                <div class="card-header" id="headingOne">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link btn-block" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                            SEMP in Information Technology <i class="fa fa-chevron-down float-right"></i>
                            ...
                            <div class="card">
                                <div class="card-header" id="headingTwo">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link collapsed btn-block" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">Is the SEMP Information Technology the right programme for me?<i class="fa fa-chevron-down float-right"></i>
                                            <i class="fa fa-chevron-up float-right"></i>
                                        </button>
                                    </h2>
                                </div>
                                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo">
                                    <div class="card-body">
                                        <div class="wpb_wrapper">
                                            <p>The SEMP Information Technology helps information technology (IT) professionals develop the necessary skills to be successful in their jobs and advance their career opportunities. This includes skills that will complement their technical skills, such as general management, leadership, strategy, interpersonal communication, relationship-building, effective consulting, and the ability to effectively influence managers outside the IT function and within the organization.</p>
                                ...
                                <div class="card-header" id="headingThree">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link collapsed btn-block" type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                            Why SEMP Information Technology? <i class="fa fa-chevron-down float-right"></i>
                                            <i class="fa fa-chevron-up float-right"></i>
                                        </button>
                                    </h2>
                                </div>
                                ...
                                <div id="collapseFour" class="collapse" aria-labelledby="headingFour">
                                    <div class="card-body">
                                        <div class="wpb_wrapper">
                                            ...
                                            <p>• Executives with responsibility for, corporate communications, and/or investor relations.<br>
                                                ...
                                                • Individuals seeking knowledge for career advancement in the field of enterprise software management<br>
                                                • Cross-functional teams from within an organization can take the program, as that accelerates the impact and engenders a common language and understanding in the organization<br>
                                                • Directors<br>
                                                • Business owners<br>
                                                • IT Trainers<br>
                                                • Corp Members<br>
                                                • Government officials</p>
                                            <p>This online certificate program in Information technology, benefits professionals at all levels who want to contribute to their organization’s performance.</p>
                            ...
                            <div class="card">
                                ...
                                <div id="collapseSeven" class="collapse" aria-labelledby="headingSeven">
                                    <div class="card-body">
                                        <p>Students who successfully complete the SEMP online programme will receive a Certificate SEMP in Information Technology from the Metropolitan School of Business and Management UK.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="card">
                                ...
                                <div id="collapseFive" class="collapse" aria-labelledby="headingFive">
                                    <div class="card-body">
                                        <div class="wpb_wrapper">
                                            <p>• Studying Effectively I<br>
                                                • Studying Effectively II<br>
                                                • Academic Research<br>
                                                • Literature Review I<br>
                                                • Literature Review II<br>
                                                • Information Systems: An Emerging Discipline<br>
                                                • Organisation as Systems<br>
                                                • Information Systems in an Organisational Context<br>
                                                • Information Technology Developments I<br>
                                                • Information Technology Developments II<br>
                                                • Information Technology Developments III<br>
