...
<body>
    ...
    <div class="main-landing-page ipdg-sm">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <div class="landing-position">
                            <div>
                                <h1 class="mba-header">Earn an Affordable, Flexible & Accredited <strong>International Postgraduate Diploma in Strategic Information and Knowledge Management</strong> (Level 7)</h1>
                        ...
                        <div class="accordion mb-5" id="msbmAccordion">
                                ...
                                <div class="card-header" id="headingOne">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link btn-block" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                            International Postgraduate Diploma in Strategic Information and Knowledge Management <i class="fa fa-chevron-down float-right"></i>
                                        ...
                                        <div class="wpb_wrapper">
                                            ...
                                            <table class="table table-striped">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td width="482">Knowledge Management</td>
                                                        <td width="155">20</td>
                                                    </tr>
                                                    <tr>
                                                        <td width="482">System Analysis And Design</td>
                                                        <td width="155">20</td>
                                                    </tr>
                                                    <tr>
                                                        <td width="482">Management Information Systems</td>
                                                        <td width="155">20</td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td width="482">Information Systems Development</td>
                                                        <td width="155">20</td>
                                                    </tr>
                                                    <tr>
                                                        <td width="482">Database Management Systems</td>
                                                        <td width="155">20</td>
                                                    </tr>
                                                    <tr>
                            ...
                            <div class="card">
                                ...
                                <div id="collapseFour" class="collapse" aria-labelledby="headingFour">
                                    <div class="card-body">
                                        <div class="wpb_wrapper">
                                            <p>The MSBM Level International Postgraduate Diploma in Strategic Information and Knowledge Management programme enables learners to progress into or within employment and/or continue their further study by topping up the degree with Masters in Information Technology at certain Universities in the UK.</p>
                                ...
                                <div class="card-header" id="headingSix">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link collapsed btn-block" type="button" data-toggle="collapse" data-target="#collapseSix" aria-expanded="false" aria-controls="collapseSix">
                                            Module 1: KNOWLEDGE MANAGEMENT <i class="fa fa-chevron-down float-right"></i>
                                            <i class="fa fa-chevron-up float-right"></i>
                                        </button>
                                    </h2>
                                </div>
                                <div id="collapseSix" class="collapse" aria-labelledby="headingSix">
                                    <div class="card-body">
                                        <div class="wpb_wrapper">
                                            ...
                                            <p>An introduction to knowledge management and its links to information systems and information professionals. A broad overview of the creation, capture, codification, sharing and application of knowledge in both tacit and explicit forms.</p>
                                            <p><strong>Learning Outcomes</strong></p>
                                            <ol>
                                                <li>To plan, initiate, implement, and evaluate knowledge management projects in private enterprises, public service administration, and educational institutions.</li>
                                                <li>To understand how to take on responsibilities as “Knowledge Manager” in different organizational settings and to direct knowledge management activities.</li>
                                                <li>To understand how to offer effective and innovative consulting in all areas of knowledge management including personal knowledge management, organizational KM, technologies and tools for KM.</li>
                                                <li>To understand how to design and manage knowledge processes.</li>
                                            </ol>
                            ...
                            <div class="card">
                                <div class="card-header" id="headingSeven">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link collapsed btn-block" type="button" data-toggle="collapse" data-target="#collapseSeven" aria-expanded="false" aria-controls="collapseSeven">
                                            Module 2: SYSTEM ANALYSIS AND DESIGN <i class="fa fa-chevron-down float-right"></i>
                                            <i class="fa fa-chevron-up float-right"></i>
                                        </button>
                                    </h2>
                                </div>
                                <div id="collapseSeven" class="collapse" aria-labelledby="headingSeven">
                                    <div class="card-body">
                                        <div class="wpb_wrapper">
                                            <p><strong>Module Aim</strong></p>
                                            <p>System analysis and design deal with planning the development of information systems through understanding and specifying in detail what a system should do and how the components of the system should be implemented and work together. System analysts solve business problems through analyzing the requirements of information systems and designing such systems by applying analysis and design techniques. This course deals with the concepts, skills, methodologies, techniques, tools, and perspectives essential for systems analysts.</p>
                                            <p><strong>Learning Outcomes</strong></p>
                                            <p>Upon successful completion of this course, students will be able to:</p>
                                            <ol>
                                                <li>Gather data to analyze and specify the requirements of a system.</li>
                                                <li>Design system components and environments.</li>
                                                <li>Build general and detailed models that assist programmers in implementing a system.</li>
                                                <li>Design a database for storing data and a user interface for data input and output, as well as controls to protect the system and its data.</li>
                                            </ol>
                            ...
                            <div class="card">
                                <div class="card-header" id="headingEight">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link collapsed btn-block" type="button" data-toggle="collapse" data-target="#collapseEight" aria-expanded="false" aria-controls="collapseEight">
                                            Module 3: DATABASE MANAGEMENT SYSTEMS <i class="fa fa-chevron-down float-right"></i>
                                            <i class="fa fa-chevron-up float-right"></i>
                                        </button>
                                    </h2>
                                </div>
                                <div id="collapseEight" class="collapse" aria-labelledby="headingEight">
                                    <div class="card-body">
                                        <div class="wpb_wrapper">
                                            <p><strong>Module Aim</strong></p>
                                            <p>The course emphasizes the understanding of the fundamentals of relational systems including data models, database architectures, and database manipulations. The course also provides an understanding of new developments and trends such as Internet database environment and data warehousing.</p>
                                            <p><strong>Learning Outcomes</strong></p>
                                            <ol>
                                                <li>Introductory knowledge of Database Management System (DBMS)</li>
                                                <li>Critically analyze Database Architecture and Modeling</li>
                                                <li>Develop entity relationship model</li>
                                                <li>Understand database normalization</li>
                                                <li>Introductory knowledge of SQL</li>
                                                <li>Critically analyze Database Security and integrity</li>
                                            </ol>
                            ...
                            <div class="card">
                                <div class="card-header" id="headingEleven">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link collapsed btn-block" type="button" data-toggle="collapse" data-target="#collapseEleven" aria-expanded="false" aria-controls="collapseEleven">
                                            Module 4: MANAGEMENT INFORMATION SYSTEMS <i class="fa fa-chevron-down float-right"></i>
                                            <i class="fa fa-chevron-up float-right"></i>
                                        </button>
                                    </h2>
                                </div>
                                <div id="collapseEleven" class="collapse" aria-labelledby="headingEleven">
                                    <div class="card-body">
                                        <div class="wpb_wrapper">
                                            <p><strong>Module Aim</strong></p>
                                            <p>This course provides a broad overview of the issues managers face in the selection, use, and management of information technology (IT). Increasingly, IT is being used as a tool to implement business strategies and gain competitive advantage, not merely to support business operations.</p>
                                            <p><strong>Learning Outcomes</strong></p>
                                            <ol>
                                                <li>Understand types of MIS applications in organisations</li>
                                                <li>Discuss the development of management information systems in organisations.</li>
                                                <li>Select and design MIS systems appropriate to meet management requirements.</li>
                                                <li>Critically evaluate MIS contributions to the strategic management of organisations</li>
                                            </ol>
                            ...
                            <div class="card">
                                <div class="card-header" id="headingNine">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link collapsed btn-block" type="button" data-toggle="collapse" data-target="#collapseNine" aria-expanded="false" aria-controls="collapseNine">
                                            Module 5: INFORMATION SYSTEMS DEVELOPMENT <i class="fa fa-chevron-down float-right"></i>
                                            <i class="fa fa-chevron-up float-right"></i>
                                        </button>
                                    </h2>
                                </div>
                                <div id="collapseNine" class="collapse" aria-labelledby="headingNine">
                                    <div class="card-body">
                                        <div class="wpb_wrapper">
                                            <p><strong>Module Aim</strong></p>
                                            <p>This course introduces the information system development process to the students. During course the students will learn about the main development frameworks, defining of system requirements, and modeling of data, architecture and components’ interactions an information system.</p>
                                            <p><strong>Learning Outcomes</strong></p>
                                            <ol>
                                                <li>Ability to describe the main tasks of an information systems development process.</li>
                                                <li>Understanding of the pros and cons of different IS development process models.</li>
                                                <li>Understanding of the basic system development modeling techniques that are common in multi-disciplinary software projects.</li>
                                            </ol>
                                ...
                                <div class="card-header" id="headingTen">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link collapsed btn-block" type="button" data-toggle="collapse" data-target="#collapseTen" aria-expanded="false" aria-controls="collapseTen">
                                            Module 6: ENTERPRISE RESOURCE PLANNING <i class="fa fa-chevron-down float-right"></i>
                                            <i class="fa fa-chevron-up float-right"></i>
                                        </button>
                                    </h2>
                                </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <p class="foot-disclaimer">
                        Disclaimer: * The logo, name and its products and services are the trademarks of Metropolitan School of Strategic Information and Knowledge Management London, UK . All other company names, brand names, trademarks and logos mentioned on this website are the property of their respective owners and do not constitute or imply endorsement, sponsorship or recommendation by the respective trademark owner.
                    </p>
                </div>
            </div>
        </div>
