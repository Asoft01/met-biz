...
<body>
    ...
    <div class="main-landing-page pgd-mkt">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <div class="landing-position">
                            <div>
                                <h1 class="mba-header">Earn an Affordable, Flexible & Accredited <strong>International Postgraduate Diploma in Marketing</strong> (Level 7)</h1>
                                ...
                                <div class="card-header" id="headingOne">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link btn-block" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                            International Postgraduate Diploma in Marketing <i class="fa fa-chevron-down float-right"></i>
                                        ...
                                        <div class="wpb_wrapper">
                                            ...
                                            <table class="table table-striped">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td width="482">Public Relations</td>
                                                        <td width="155">20</td>
                                                    </tr>
                                                    <tr>
                                                        <td width="482">Marketing Communications/Digital Marketing</td>
                                                        <td width="155">20</td>
                                                    </tr>
                                                    <tr>
                                                        <td width="482">International Marketing Management</td>
                                                        <td width="155">20</td>
                                                    </tr>
                                                    <tr>
                                                        <td width="482">International Business Strategy</td>
                                                        <td width="155">20</td>
                                                    </tr>
                                                    <tr>
                                                        <td width="482">Operations and Supply Chain Management</td>
                                                        <td width="155">20</td>
                                                    </tr>
                                                    <tr>
                                ...
                                <div class="card-header" id="headingSeven">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link collapsed btn-block" type="button" data-toggle="collapse" data-target="#collapseSeven" aria-expanded="false" aria-controls="collapseSeven">
                                            Module 2: DIGITAL MARKETING <i class="fa fa-chevron-down float-right"></i>
                                            <i class="fa fa-chevron-up float-right"></i>
                                        </button>
                                    </h2>
                                </div>
                            ...
                            <div class="card">
                                <div class="card-header" id="headingEight">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link collapsed btn-block" type="button" data-toggle="collapse" data-target="#collapseEight" aria-expanded="false" aria-controls="collapseEight">
                                            Module 3: PUBLIC RELATIONS <i class="fa fa-chevron-down float-right"></i>
                                            <i class="fa fa-chevron-up float-right"></i>
                                        </button>
                                    </h2>
                                </div>
                                <div id="collapseEight" class="collapse" aria-labelledby="headingEight">
                                    <div class="card-body">
                                        <div class="wpb_wrapper">
                                            <p><strong>Module Aim</strong></p>
                                            <p>The module introduces the fundamentals of PR, looks at the role of the PR practitioner and introduces fundamental PR skills including how to work with the media, what makes a great news story and how to write effectively for online and offline channels.</p>
                                            <p><strong>Learning Outcomes</strong></p>
                                            <ol>
                                                <li>The role and scope of public relations</li>
                                                <li>The differences between public relations, marketing, advertising, publicity, public information, spin and propaganda</li>
                                                <li>Key PR terminology</li>
                                                <li>The importance of PR ethics</li>
                                                <li>The key principles of effective media relations</li>
                                            </ol>
                            ...
                            <div class="card">
                                <div class="card-header" id="headingEleven">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link collapsed btn-block" type="button" data-toggle="collapse" data-target="#collapseEleven" aria-expanded="false" aria-controls="collapseEleven">
                                            Module 4: INTERNATIONAL MARKETING MANAGEMENT <i class="fa fa-chevron-down float-right"></i>
                                            <i class="fa fa-chevron-up float-right"></i>
                                        </button>
                                    </h2>
                                </div>
                                <div id="collapseEleven" class="collapse" aria-labelledby="headingEleven">
                                    <div class="card-body">
                                        <div class="wpb_wrapper">
                                            <p><strong>Module Aim</strong></p>
                                            <p>The module provides students with knowledge of the theory, concepts, issues and practice of international marketing. It identifies processes, contexts and influences associated with international marketing strategies, develops students’ appreciation both of strategies and plans for different economies and of the implications, monitoring and control of the international marketing process.</p>
                                            <p><strong>Learning Outcomes</strong></p>
                                            <ol>
                                                <li>Be able to investigate control mechanism in an organisation operating globally.</li>
                                                <li>Be able to examine the role of pricing, product and advertisement planning in strategic decision making</li>
                                                <li>Be able to demonstrate an ability to formulate and access international marketing strategies</li>
                                                <li>Be able to understand an appropriate international marketing segmentation for target market and product positioning</li>
                                                <li>Be able to understand critical emerging issues in international marketing</li>
                                            </ol>
                                ...
                                <div class="card-header" id="headingNine">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link collapsed btn-block" type="button" data-toggle="collapse" data-target="#collapseNine" aria-expanded="false" aria-controls="collapseNine">
                                            Module 5: OPERATIONS AND SUPPLY CHAIN MANAGEMENT <i class="fa fa-chevron-down float-right"></i>
                                            <i class="fa fa-chevron-up float-right"></i>
                                        </button>
                                    </h2>
                                </div>
                            ...
                            <div class="card">
                                <div class="card-header" id="headingTen">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link collapsed btn-block" type="button" data-toggle="collapse" data-target="#collapseTen" aria-expanded="false" aria-controls="collapseTen">
                                            Module 6: INTERNATIONAL BUSINESS STRATEGY <i class="fa fa-chevron-down float-right"></i>
                                            <i class="fa fa-chevron-up float-right"></i>
                                        </button>
                                    </h2>
                                </div>
                                <div id="collapseTen" class="collapse" aria-labelledby="headingTen">
                                    <div class="card-body">
                                        <div class="wpb_wrapper">
                                            <p><strong>Module Aim</strong></p>
                                            <p>This course aims introduce learners to current debates, theories and practices in the field of International Business.</p>
                                            <p><strong>Learning Outcomes</strong></p>
                                            <ol>
                                                <li>Be able to understand the nature, scope and process for strategic business management and planning in organisations doing business globally.</li>
                                                <li>Be able to identify the impact of International environment forces on an organisation.</li>
                                                <li>Be able to understand the impact of present economic recession in an internal analysis to an organisation business strategic planning and development</li>
                                                <li>Be able to understand missions, objectives, proposes and strategies process to organisations and industries at national and international context</li>
                                                <li>Be able to appreciate coherent and persuasive arguments for the adoption of innovative strategies for a range of business and organisational situations</li>
                                            </ol>
            ...
            <div class="row">
                <div class="col-md-12">
                    <p class="foot-disclaimer">
                        Disclaimer: * The logo, name and its products and services are the trademarks of Metropolitan School of Marketing London, UK . All other company names, brand names, trademarks and logos mentioned on this website are the property of their respective owners and do not constitute or imply endorsement, sponsorship or recommendation by the respective trademark owner.
                    </p>
                </div>
            </div>
        </div>
