...
<body>
    ...
    <div class="main-landing-page nigeria">
        <div class="landing-page-form landing-nigeria">
            <div class="container">
                <div class="row">
                    <div class="landing-pos">
                        <div class="col-lg-8">
                            <h1 class="numero-unoxx">Study for 3 years <strong>Anglia Ruskin University Bachelor's Degree</strong></h1>
                            <h4 class="sub-numero-unoxx">Two years in <strong>Lagos, Nigeria</strong></h4>
                            <h4 class="sub-numero-unoxx">One Year in the <strong>UK, Dubai, Cyprus or Mauritius</strong></h4>
                        </div>
        ...
        <section class="landing-camp">
            <div class="container">
                <h2 class="text-center mb-5">Lagos, Nigeria Campus</h2>
                <!-- <div class="center-line"></div> -->
                <div class="row">
                    <div class="col-lg-3 col-6">
                        <div class="training-image"><img src="<?php echo ROOT_DIR; ?>images/banners/ag01.jpg" alt="" class="img-fluid"></div>
                    </div>

                    <div class="col-lg-3 col-6">
                        <div class="training-image"><img src="<?php echo ROOT_DIR; ?>images/banners/ag02.jpg" alt="" class="img-fluid"></div>
                    </div>

                    <div class="col-lg-3 col-6">
                        <div class="training-image"><img src="<?php echo ROOT_DIR; ?>images/banners/ag03.jpg" alt="" class="img-fluid "></div>
                    </div>

                    <div class="col-lg-3 col-6">
                        <div class="training-image"><img src="<?php echo ROOT_DIR; ?>images/banners/ag04.jpg" alt="" class="img-fluid "></div>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="landing-camp">
            <div class="container">
                <h2 class="text-center mb-5">Accommodation Facilities</h2>
                <!-- <div class="center-line"></div> -->
                <div class="row">
                    <div class="col-lg-3 col-6">
                        <div class="training-image"><img src="<?php echo ROOT_DIR; ?>images/banners/entr01.jpg" alt="" class="img-fluid"></div>
                    </div>

                    <div class="col-lg-3 col-6">
                        <div class="training-image"><img src="<?php echo ROOT_DIR; ?>images/banners/inng1.jpg" alt="" class="img-fluid"></div>
                    </div>

                    <div class="col-lg-3 col-6">
                        <div class="training-image"><img src="<?php echo ROOT_DIR; ?>images/banners/inng3.jpg" alt="" class="img-fluid "></div>
                    </div>

                    <div class="col-lg-3 col-6">
                        <div class="training-image"><img src="<?php echo ROOT_DIR; ?>images/banners/inng8.jpg" alt="" class="img-fluid "></div>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="final-landing">
            <div class="container">
                <h2 class="mb-5">Complete your final year in any of the <br />following countries</h2>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        <div class="card session-card">
                            <img src="<?php echo ROOT_DIR; ?>images/banners/uk1.jpg" class="card-img-top" alt="">
                        </div>
                    ...
                    <div class="col-lg-3">
                        <div class="card session-card">
                            <img src="<?php echo ROOT_DIR; ?>images/banners/uae1.jpg" class="card-img-top" alt="">
                        </div>
                    ...
                    <div class="col-lg-3">
                        <div class="card session-card">
                            <img src="<?php echo ROOT_DIR; ?>images/banners/cyprus1.jpg" class="card-img-top" alt="">
                        </div>
                    ...
                    <div class="col-lg-3">
                        <div class="card session-card">
                            <img src="<?php echo ROOT_DIR; ?>images/banners/mauritius1.jpg" class="card-img-top" alt="">
                        </div>
                    ...
                    <div class="col-lg-6 mx-auto mt-5">
                        <div class="row">
                            <div class="col-lg-6">
                                <button class="btn btn-dark mb-2 btn-block">Get More Information</button>
                            </div>
