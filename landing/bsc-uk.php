            ...
            <div class="container">
                <div class="row">
                    <div class="landing-pos">
                        <div class="col-lg-8">
                            <h1 class="numero-unoxx">Study for an <strong>Anglia Ruskin University Bachelor's Degree</strong> here in <strong>London</strong></h1>
                            <h4 class="sub-numero-unoxx">Classroom option available for those already residing in the London</h4>
                            <h4 class="sub-numero-unoxx">Online option also available for those outside the London</h4>
                        </div>
