...
<body>
    ...
    <div class="main-landing-page pgd-esb">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <div class="landing-position">
                            <div>
                                <h1 class="mba-header">Earn an Affordable, Flexible & Accredited <strong>International Postgraduate Diploma in Enterprise Software and Business Infrastructure</strong> (Level 7)</h1>
                        ...
                        <div class="accordion mb-5" id="msbmAccordion">
                            <div class="card">
                                <div class="card-header" id="headingOne">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link btn-block" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                            International Postgraduate Diploma in Enterprise Software and Business Infrastructure <i class="fa fa-chevron-down float-right"></i>
                                ...
                                <div id="collapseOne" class="collapse show" aria-labelledby="headingOne">
                                    <div class="card-body">
                                        The International Postgraduate Diploma in Information Technology designed to develop and refine a set of skills essential for successful engagement of enterprises with information and communications technology (ICT).
                                    </div>
                                </div>
                            </div>
                            <div class="card">
                                        ...
                                        <div class="wpb_wrapper">
                                            ...
                                            <table class="table table-striped">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td width="482">Enterprise Software Development</td>
                                                        <td width="155">20</td>
                                                    </tr>
                                                    <tr>
                                ...
                                <div class="card-header" id="headingSix">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link collapsed btn-block" type="button" data-toggle="collapse" data-target="#collapseSix" aria-expanded="false" aria-controls="collapseSix">
                                            Module 1: ENTERPRISE SOFTWARE DEVELOPMENT <i class="fa fa-chevron-down float-right"></i>
                                            <i class="fa fa-chevron-up float-right"></i>
                                        </button>
                                    </h2>
                                </div>
                                <div id="collapseSix" class="collapse" aria-labelledby="headingSix">
                                    <div class="card-body">
                                        <div class="wpb_wrapper">
                                            ...
                                            <p>Enterprise Software development provides advanced concepts, skills and knowledge for those currently employed in the information technology and related fields, or graduates of information technology or computer studies programs.</p>
                                            <p><strong>Learning Outcomes</strong></p>
                                            <ol>
                                                <li>Reason and problem-solve to a high level in the context of enterprise software and its role in business, industry and research</li>
                                                <li>Participate constructively in the strategic deployment of enterprise software</li>
                                                <li>Manage the development of high-quality enterprise software products and services.</li>
                                            </ol>
