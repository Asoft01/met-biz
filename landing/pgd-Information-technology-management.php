...
<body>
    ...
    <div class="main-landing-page pgd-itm">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <div class="landing-position">
                            <div>
                                <h1 class="mba-header">Earn an Affordable, Flexible & Accredited <strong>International Postgraduate Diploma in Information Technology Management</strong> (Level 7)</h1>
                        ...
                        <div class="accordion mb-5" id="msbmAccordion">
                                ...
                                <div class="card-header" id="headingOne">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link btn-block" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                            International Postgraduate Diploma in Information Technology Management <i class="fa fa-chevron-down float-right"></i>
                                        ...
                                        <div class="wpb_wrapper">
                                            ...
                                            <table class="table table-striped">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td width="482">IT Tools And Networks</td>
                                                        <td width="155">20</td>
                                                    </tr>
                                                    <tr>
                            ...
                            <div class="card">
                                ...
                                <div id="collapseFour" class="collapse" aria-labelledby="headingFour">
                                    <div class="card-body">
                                        <div class="wpb_wrapper">
                                            <p>The MSBM Level International Postgraduate Diploma in Information Technology Management programme enables learners to progress into or within employment and/or continue their further study by topping up the degree with Masters in Information Technology Management at certain Universities in the UK.</p>
                                ...
                                <div class="card-header" id="headingSix">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link collapsed btn-block" type="button" data-toggle="collapse" data-target="#collapseSix" aria-expanded="false" aria-controls="collapseSix">
                                            Module 1: IT TOOLS AND NETWORKS <i class="fa fa-chevron-down float-right"></i>
                                            <i class="fa fa-chevron-up float-right"></i>
                                        </button>
                                    </h2>
                                </div>
                                <div id="collapseSix" class="collapse" aria-labelledby="headingSix">
                                    <div class="card-body">
                                        <div class="wpb_wrapper">
                                            ...
                                            <p>This course will covers computer appreciation, advanced fundamental design and implementation principles of Internet, key networking issues and their solutions.</p>
                                            <p><strong>Learning Outcomes</strong></p>
                                            <ol>
                                                <li>Computer Appreciation</li>
                                                <li>Thorough understanding of Central Processing Unit, Memory and Output Devices</li>
                                                <li>Develop the knowledge of different versions of windows, basic windows elements and file management through windows</li>
                                                <li>Networking Architecture: ISO-OSI, IBM, SNA architecture, their function and implementation.</li>
                                            </ol>
                                    ...
                                    <div class="card-body">
                                        <div class="wpb_wrapper">
                                            ...
                                            <ol>
                                                ...
                                                <li>Be able to review, evaluate and closeout a project<strong>&nbsp;</strong></li>
                                            </ol>
            ...
            <div class="row">
                <div class="col-md-12">
                    <p class="foot-disclaimer">
                        Disclaimer: * The logo, name and its products and services are the trademarks of Metropolitan School of Information Technology Management London, UK . All other company names, brand names, trademarks and logos mentioned on this website are the property of their respective owners and do not constitute or imply endorsement, sponsorship or recommendation by the respective trademark owner.
                    </p>
                </div>
            </div>
        </div>
