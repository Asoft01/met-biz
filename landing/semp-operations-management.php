...
<body>
    ...
    <div class="main-landing-page opera">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <div class="landing-position">
                            <div>
                                <h1 class="mba-header"><strong>SPECIAL EXECUTIVE MASTERS PROGRAMME</strong> in <strong>Operations Management</strong></h1>
                        ...
                        <div class="accordion mb-5" id="msbmAccordion">
                                ...
                                <div class="card-header" id="headingOne">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link btn-block" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                            SEMP in Operations Management <i class="fa fa-chevron-down float-right"></i>
                                ...
                                <div id="collapseOne" class="collapse show" aria-labelledby="headingOne">
                                    <div class="card-body">
                                        <div class="wpb_wrapper">
                                            <p>The encapsulated Senior Executive Programme in Operations Management is for high performance managers and directors who work in critical roles using available resources to effectively produce products and services in a way that satisfies the customers. The programme is also useful for managers and directors who need an intensive course to cover the key areas that drive success and profit in everyday business operations.</p>
                            ...
                            <div class="card">
                                <div class="card-header" id="headingTwo">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link collapsed btn-block" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">Is the SEMP Operations Management the right programme for me?<i class="fa fa-chevron-down float-right"></i>
                                            <i class="fa fa-chevron-up float-right"></i>
                                        </button>
                                    </h2>
                                </div>
                            ...
                            <div class="card">
                                <div class="card-header" id="headingThree">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link collapsed btn-block" type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                            Why SEMP Operations Management? <i class="fa fa-chevron-down float-right"></i>
                                            <i class="fa fa-chevron-up float-right"></i>
                                        </button>
                                    </h2>
                                </div>
                                <div id="collapseThree" class="collapse" aria-labelledby="headingThree">
                                    <div class="card-body">
                                        <div class="wpb_wrapper">
                                            <p>In recent years there has been a lot of talk about competitive advantage, something that every business seeks. Many debates more specifically focus on how operations management can deliver competitive advantage in different environment. When enrolled for this programme, you will gain a complete and thorough grounding in the four major concepts of competitive advantage in operations management which are:</p>
                                            <p>• Cost Leadership<br>
                            ...
                            <div class="card">
                                <div class="card-header" id="headingFour">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link collapsed btn-block" type="button" data-toggle="collapse" data-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                                            More reasons to enroll in this online Certificate Program? <i class="fa fa-chevron-down float-right"></i>
                                            <i class="fa fa-chevron-up float-right"></i>
                                        </button>
                                    </h2>
                                </div>
                                <div id="collapseFour" class="collapse" aria-labelledby="headingFour">
                                    <div class="card-body">
                                        <div class="wpb_wrapper">
                                            <p>• Personal career development<br>
                                                ...
                                                • Personal recommendations by online alumni students<br>
                                                • A ‘taster’ before embarking upon an academic Masters programme<br>
                                                • Broadening of business expertise for those from public and non-profit making organisation.<br>
                                                • People without previous University, Polytechnics or College degrees.<br>
                                                • There is no strict requirement for this programme as it is a non-credit bearing programme.<br>
                            ...
                            <div class="card">
                                ...
                                <div id="collapseSeven" class="collapse" aria-labelledby="headingSeven">
                                    <div class="card-body">
                                        <p>Students who successfully complete the SEMP online programme will receive a Certificate SEMP in Operations Management from the Metropolitan School of Business and Management UK.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="card">
                                ...
                                <div id="collapseFive" class="collapse" aria-labelledby="headingFive">
                                    <div class="card-body">
                                        <div class="wpb_wrapper">
                                            <ul>
                                                <li>Introduction to Strategic Operations</li>
                                                <li>Strategic thinking for Operations</li>
                                                <li>Operations Strategy Planning</li>
                                                <li>Product and Process Design</li>
                                                <li>Supply Chain Network Design</li>
                                                <li>Layout and Flow Design</li>
                                                <li>Process Technology</li>
                                                <li>HR Issues and Job Design</li>
                                                <li>Improvement and Quality in Operations</li>
                                                <li>Planning and Control I</li>
                                                <li>Planning and Control II</li>
