...
<body>
    ...
    <div class="main-landing-page pgd">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <div class="landing-position">
                            <div>
                                <h1 class="mba-header">Earn an Affordable, Flexible & Accredited British <strong>International Postgraduate Diploma in Strategic Management</strong> (Level 7)</h1>
                        ...
                        <div class="accordion mb-5" id="msbmAccordion">
                            <div class="card">
                                <div class="card-header" id="headingOne">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link btn-block" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                            International Postgraduate Diploma in Strategic Management <i class="fa fa-chevron-down float-right"></i>
                                ...
                                <div id="collapseOne" class="collapse show" aria-labelledby="headingOne">
                                    <div class="card-body">
                                        <p>The International Postgraduate Diploma in Strategic Management is designed to provide in depth knowledge and understanding of the various aspect of strategic management within the organisational context. It provides a rich collaborative learning experience where learner exchange views with other participants, interact with research active tutors, and are challenged to become a reflective manager.</p>

                                        <p>The International Postgraduate Diploma in Strategic Management also provides learners with realistic and appropriate career related guidance for early 21st century employment markets. Moreover, it creates an opportunity for learners to complete their MBA degree from the UK recognized University at the dissertation phase</p>
                                    </div>
                                </div>
                            </div>
                            <div class="card">
                                        ...
                                        <div class="wpb_wrapper">
                                            ...
                                            <table class="table table-striped">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td width="482">Strategic Marketing Management</td>
                                                        <td width="155">20</td>
                                                    </tr>
                                                    <tr>
                                                        <td width="482">Strategic Management</td>
                                                        <td width="155">20</td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td width="482">Strategic Financial Management</td>
                                                        <td width="155">20</td>
                                                    </tr>
                                                    <tr>
                                                        <td width="482">Strategic Change Management</td>
                                                        <td width="155">20</td>
                                                    </tr>
                                                    <tr>
                            ...
                            <div class="card">
                                ...
                                <div id="collapseFour" class="collapse" aria-labelledby="headingFour">
                                    <div class="card-body">
                                        <div class="wpb_wrapper">
                                            <p>The MSBM International Postgraduate Diploma in Strategic Management programme enables learners to progress into or within employment and/or continue their further study by topping up the degree with Masters in Business Administration at certain Universities in the UK.</p>
                                ...
                                <div class="card-header" id="headingSix">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link collapsed btn-block" type="button" data-toggle="collapse" data-target="#collapseSix" aria-expanded="false" aria-controls="collapseSix">
                                            Module 1: STRATEGIC MARKETING <i class="fa fa-chevron-down float-right"></i>
                                            <i class="fa fa-chevron-up float-right"></i>
                                        </button>
                                    </h2>
                                </div>
                                <div id="collapseSix" class="collapse" aria-labelledby="headingSix">
                                    <div class="card-body">
                                        <div class="wpb_wrapper">
                                            ...
                                            <ul>
                                                <li>Understand how to analyze an organisation’s current and future external environment Understand how to analyze an organisation’s current and future internal environment</li>
                                                <li>Planning analyze relevant information to recommend and inform strategic decision making</li>
                                                <li>Develop a strategic marketing plan to realize organisational objectives</li>
                                                <li>Implementation and control Manage resources to deliver the strategic marketing plan</li>
                                                <li>Monitor, measure and adapt the marketing plan for continuous improvement</li>
                                            </ul>
                                ...
                                <div class="card-header" id="headingSeven">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link collapsed btn-block" type="button" data-toggle="collapse" data-target="#collapseSeven" aria-expanded="false" aria-controls="collapseSeven">
                                            Module 2: STRATEGIC HUMAN RESOURCE MANAGEMENT AND DEVELOPMENT <i class="fa fa-chevron-down float-right"></i>
                                            <i class="fa fa-chevron-up float-right"></i>
                                        </button>
                                    </h2>
                                </div>
                            ...
                            <div class="card">
                                <div class="card-header" id="headingEight">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link collapsed btn-block" type="button" data-toggle="collapse" data-target="#collapseEight" aria-expanded="false" aria-controls="collapseEight">
                                            Module 3: STRATEGIC FINANCIAL MANAGEMENT <i class="fa fa-chevron-down float-right"></i>
                                            <i class="fa fa-chevron-up float-right"></i>
                                        </button>
                                    </h2>
                                </div>
                                <div id="collapseEight" class="collapse" aria-labelledby="headingEight">
                                    <div class="card-body">
                                        <div class="wpb_wrapper">
                                            <p><strong>Module Aim</strong></p>
                                            <p>On completion of this unit, learners will have gained knowledge and understanding relating to planning the usage and management of a business organisation’s financial resources.&nbsp; Learners will understand the importance of attaining business objectives and maximizing shareholder return. Learners will gain a working knowledge of business strategy design and the production of comprehensive business plans</p>
                                            <p><strong>Learning Outcomes</strong></p>
                                            <ol>
                                                <li>Understand the significance of strategic management and decision making to the performance of a business organization</li>
                                                <li>Understand key financial theories</li>
                                                <li>Be able to apply stakeholder analysis and corporate valuation techniques</li>
                                                <li>Understand the role of culture in strategic decision making</li>
                                                <li>Understand performance measurement systems</li>
                                            </ol>
                            ...
                            <div class="card">
                                <div class="card-header" id="headingEleven">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link collapsed btn-block" type="button" data-toggle="collapse" data-target="#collapseEleven" aria-expanded="false" aria-controls="collapseEleven">
                                            Module 4: STRATEGIC MANAGEMENT <i class="fa fa-chevron-down float-right"></i>
                                            <i class="fa fa-chevron-up float-right"></i>
                                        </button>
                                    </h2>
                                </div>
                                <div id="collapseEleven" class="collapse" aria-labelledby="headingEleven">
                                    <div class="card-body">
                                        <div class="wpb_wrapper">
                                            <p><strong>Module Aim</strong></p>
                                            <p>To examine the principles of strategy and change management and provide learners with a critical understanding and ability to use various models of the strategy and change management process and the analysis of internal external environmental and resource variables.</p>
                                            <p><strong>Learning Outcomes</strong></p>
                                            <ol>
                                                <li>Be able to critically review strategic plans.</li>
                                                <li>Be able to propose strategic options for an organisation.</li>
                                                <li>Be able to create a strategy implementation plan</li>
                                                <li>Be able to implement a strategic organisational change.</li>
                                                <li>Be able to review the implementation of strategic plans</li>
                                            </ol>
                            ...
                            <div class="card">
                                <div class="card-header" id="headingNine">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link collapsed btn-block" type="button" data-toggle="collapse" data-target="#collapseNine" aria-expanded="false" aria-controls="collapseNine">
                                            Module 5: STRATEGIC CHANGE MANAGEMENT <i class="fa fa-chevron-down float-right"></i>
                                            <i class="fa fa-chevron-up float-right"></i>
                                        </button>
                                    </h2>
                                </div>
                                <div id="collapseNine" class="collapse" aria-labelledby="headingNine">
                                    <div class="card-body">
                                        <div class="wpb_wrapper">
                                            <p><strong>Module Aim</strong></p>
                                            <p>The aim of this unit is to develop learners’ understanding of classic and contemporary theories of change management and how they apply to contemporary organisations in the globalised world, with the identification and use of change models. Learners will understand the personal characteristics of change agents as well as the evaluation and development of leadership skills to meet current and future change management roles.</p>
                                            <p><strong>Learning Outcomes</strong></p>
                                            <ol>
                                                <li>Be able to evaluate change agents’ knowledge, attributes skills and development</li>
                                                <li>Be able to critically analyse approaches to organisational change and their processes</li>
                                                <li>Be able to create a plan and implement effective change within an organisation.</li>
                                                <li>Be able to analyse stakeholder responses to Organizational change</li>
                                                <li>Be able to involve functional areas in an organisation’s change management.</li>
                                            </ol>
                                ...
                                <div class="card-header" id="headingTen">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link collapsed btn-block" type="button" data-toggle="collapse" data-target="#collapseTen" aria-expanded="false" aria-controls="collapseTen">
                                            Module 6: RESEARCH PROJECT <i class="fa fa-chevron-down float-right"></i>
                                            <i class="fa fa-chevron-up float-right"></i>
                                        </button>
                                    </h2>
                                </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <p class="foot-disclaimer">
                        Disclaimer: * The logo, name and its products and services are the trademarks of Metropolitan School of Strategic Management London, UK . All other company names, brand names, trademarks and logos mentioned on this website are the property of their respective owners and do not constitute or imply endorsement, sponsorship or recommendation by the respective trademark owner.
                    </p>
                </div>
            </div>
        </div>
