...
<body>
    ...
    <div class="main-landing-page inter">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <div class="landing-position">
                            <div>
                                <h1 class="mba-header"><strong>SPECIAL EXECUTIVE MASTERS PROGRAMME</strong> in <strong>International Marketing</strong></h1>
                        ...
                        <div class="accordion mb-5" id="msbmAccordion">
                                ...
                                <div class="card-header" id="headingOne">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link btn-block" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                            SEMP in International Marketing <i class="fa fa-chevron-down float-right"></i>
                                ...
                                <div id="collapseOne" class="collapse show" aria-labelledby="headingOne">
                                    <div class="card-body">
                                        <div class="wpb_wrapper">
                                            <p>The encapsulated Senior Executive Programme in International Marketing Strategy is for high performance managers and directors who work in critical roles using available resources to effectively produce products and services in a way that satisfies the customers. The programme is also useful for managers and directors who need an intensive course to cover the key areas that drive success and profit in everyday business marketing.</p>
                            ...
                            <div class="card">
                                <div class="card-header" id="headingTwo">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link collapsed btn-block" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">Is the SEMP International Marketing the right programme for me?<i class="fa fa-chevron-down float-right"></i>
                                            <i class="fa fa-chevron-up float-right"></i>
                                        </button>
                                    </h2>
                                </div>
                            ...
                            <div class="card">
                                <div class="card-header" id="headingThree">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link collapsed btn-block" type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                            Why SEMP International Marketing? <i class="fa fa-chevron-down float-right"></i>
                                            <i class="fa fa-chevron-up float-right"></i>
                                        </button>
                                    </h2>
                                </div>
                                <div id="collapseThree" class="collapse" aria-labelledby="headingThree">
                                    <div class="card-body">
                                        <div class="wpb_wrapper">
                                            <p>This programme is designed to give you a comprehensive understanding of the key skills and practices used by marketing executives and their organizations to make informed marketing decisions that are vital to the success of any business. Participants will learn how to critically evaluate key marketing models and apply them in a real-life business problem at a strategic level.</p>
                                            <p>This 100% online certificate enhances your understanding of marketing’s role in organizational strategy, and highlights the advantages of using a cross-functional perspective to lead successful companies or units.</p>
                            ...
                            <div class="card">
                                ...
                                <div id="collapseFour" class="collapse" aria-labelledby="headingFour">
                                    <div class="card-body">
                                        <div class="wpb_wrapper">
                                            <p>The SEMP International Marketing Strategy programme is designed for entry-level managers, up to mid-level managers, senior managers or directors who are in general marketing role or fast approaching such position and is seeking an opportunity to obtain a richer, deeper understanding of marketing skills.</p>
                                            <p>Here are some of our current online SEMP IMS students</p>

                                            <div class="wpb_wrapper">
                                                <ul style="column-count: 2">
                                                    <li>Marketing Professionals</li>
                                                    <li>Senior Marketing Directors</li>
                                                    <li>Marketing Managers</li>
                                                    <li>Business Owners</li>
                                                    <li>Importer and Exporter</li>
                                                    <li>Multinational Company Executives</li>
                                                    <li>Government officials.</li>
                                                    <li>People without previous University, Polytechnics or College degrees</li>
                                                </ul>
                                            </div>
                            ...
                            <div class="card">
                                ...
                                <div id="collapseSeven" class="collapse" aria-labelledby="headingSeven">
                                    <div class="card-body">
                                        <p>Students who successfully complete the SEMP online programme will receive a Certificate SEMP in International Marketing from the Metropolitan School of Business and Management UK.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="card">
                                ...
                                <div id="collapseFive" class="collapse" aria-labelledby="headingFive">
                                    <div class="card-body">
                                        <div class="wpb_wrapper">
                                            <ul>
                                                <li>Culture, Mindset and Behaviour</li>
                                                <li>Cross-Cultural Consumer Behaviour</li>
                                                <li>Global vs. local Consumerism I</li>
                                                <li>Convergence of Marketing Environments</li>
                                                <li>Cross-Cultural Market Research</li>
                                                <li>Buyer Behaviour and Targeting</li>
                                                <li>Global vs. Consumerism II</li>
                                                <li>International Pricing</li>
                                                <li>Distribution, Sales promotion and Marketing Entry Strategy</li>
                                                <li>International Marketing Communications and Buyer Behaviour</li>
                                                <li>Improving International Marketing Communications and Promotions</li>
                                                <li>Critical Reflection of Key Issues in international Marketing Strategy.</li>
                                            </ul>
