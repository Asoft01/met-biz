...
<body>
    ...
    <div class="main-landing-page pgd-proj">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <div class="landing-position">
                            <div>
                                <h1 class="mba-header">Earn an Affordable, Flexible & Accredited <strong>International Postgraduate Diploma in Project Management</strong> (Level 7)</h1>
                        ...
                        <div class="accordion mb-5" id="msbmAccordion">
                            <div class="card">
                                <div class="card-header" id="headingOne">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link btn-block" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                            International Postgraduate Diploma in Project Management <i class="fa fa-chevron-down float-right"></i>
                                ...
                                <div id="collapseOne" class="collapse show" aria-labelledby="headingOne">
                                    <div class="card-body">
                                        <p>Project management impacts directly on the growth and advancement of most modern organisations and is a much-sought-after qualification. The MSBM Postgraduate Diploma in Project Management is a one year specialized programme that enables students to develop an advanced understanding of concepts, approaches and tools relevant to the field of project management in the 21st Century.</p>

                                        <p>The programme enhances the capacity of managers to improve production and service delivery thereby contributing to organisational effectiveness. The programme also provides for the attainment of quantitative skills in Project Finance and Project Management.</p>
                                    </div>
                                        ...
                                        <div class="wpb_wrapper">
                                            ...
                                            <table class="table table-striped">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td width="482">Supply Chain Management</td>
                                                        <td width="155">20</td>
                                                    </tr>
                                                    <tr>
                            ...
                            <div class="card">
                                ...
                                <div id="collapseFour" class="collapse" aria-labelledby="headingFour">
                                    <div class="card-body">
                                        <p>The MSBM Level 7 Diploma in Project Management programme enables learners to progress into or within employment and/or continue their further study by topping up the degree with Masters in Project Management at certain Universities in the UK.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="card">
                                ...
                                <div class="card-header" id="headingSix">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link collapsed btn-block" type="button" data-toggle="collapse" data-target="#collapseSix" aria-expanded="false" aria-controls="collapseSix">
                                            Module 1: PROJECT MANAGEMENT <i class="fa fa-chevron-down float-right"></i>
                                            <i class="fa fa-chevron-up float-right"></i>
                                        </button>
                                    </h2>
                                </div>
                                ...
                                <div class="card-header" id="headingEight">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link collapsed btn-block" type="button" data-toggle="collapse" data-target="#collapseEight" aria-expanded="false" aria-controls="collapseEight">
                                            Module 3: RESEARCH PROJECT <i class="fa fa-chevron-down float-right"></i>
                                            <i class="fa fa-chevron-up float-right"></i>
                                        </button>
                                    </h2>
                                </div>
                                ...
                                <div class="card-header" id="headingEleven">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link collapsed btn-block" type="button" data-toggle="collapse" data-target="#collapseEleven" aria-expanded="false" aria-controls="collapseEleven">
                                            Module 4: ENTERPRISE RESOURCE PLANNING <i class="fa fa-chevron-down float-right"></i>
                                            <i class="fa fa-chevron-up float-right"></i>
                                        </button>
                                    </h2>
                                </div>
                                ...
                                <div class="card-header" id="headingNine">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link collapsed btn-block" type="button" data-toggle="collapse" data-target="#collapseNine" aria-expanded="false" aria-controls="collapseNine">
                                            Module 5: TOTAL QUALITY MANAGEMENT <i class="fa fa-chevron-down float-right"></i>
                                            <i class="fa fa-chevron-up float-right"></i>
                                        </button>
                                    </h2>
                                </div>
                            ...
                            <div class="card">
                                <div class="card-header" id="headingTen">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link collapsed btn-block" type="button" data-toggle="collapse" data-target="#collapseTen" aria-expanded="false" aria-controls="collapseTen">
                                            Module 6: SUPPLY CHAIN MANAGEMENT <i class="fa fa-chevron-down float-right"></i>
                                            <i class="fa fa-chevron-up float-right"></i>
                                        </button>
                                    </h2>
                                </div>
                                <div id="collapseTen" class="collapse" aria-labelledby="headingTen">
                                    <div class="card-body">
                                        <div class="wpb_wrapper">
                                            <p><strong>Module Aim</strong></p>
                                            <p>At the completion of this course, the student should be able to examine the design and performance of supply networks and processes in different business contexts. Students develop capabilities in logistics, digital coordination for supply chain integration, inventory management, risk pooling, procurement, product and process design, and international supply chain management</p>
                                            <p><strong>Learning Outcomes</strong></p>
                                            <ol>
                                                <li>Configure logistics networks and assess their performance impacts on efficiency and service levels</li>
                                                <li>Manage inventory efficiently and pool inventory risks across time, products, channels, and geography.</li>
                                                <li>Design supply chain contracts for effective governance of supply chain relationships.</li>
                                                <li>Diagnose information integration problems across the supply chain and their consequent impacts in deploying physical and financial resources</li>
                                                <li>Evaluate alternate information sharing and lead time compression strategies, and supply chain coordination structures, and their organizational and performance implications.</li>
                                                <li>Align supply chain integration strategy with the uncertainty conditions of supply and demand.</li>
                                                <li>Optimally position the push-pull boundary to leverage economies of scale and economies of scope.</li>
                                                <li>Evaluate distribution strategies to balance responsiveness and efficiency.</li>
                                                <li>Design e-procurement strategies for a firm’s procurement portfolio of products and services.</li>
                                                <li>Evaluate how the logistics process can be constrained by product design, and the implications of constraint reduction on logistics performance and market responsiveness.</li>
                                            </ol>
            ...
            <div class="row">
                <div class="col-md-12">
                    <p class="foot-disclaimer">
                        Disclaimer: * The logo, name and its products and services are the trademarks of Metropolitan School of Project Management London, UK . All other company names, brand names, trademarks and logos mentioned on this website are the property of their respective owners and do not constitute or imply endorsement, sponsorship or recommendation by the respective trademark owner.
                    </p>
                </div>
            </div>
        </div>
