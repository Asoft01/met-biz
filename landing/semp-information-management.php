...
<body>
    ...
    <div class="main-landing-page info-mgt">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <div class="landing-position">
                            <div>
                                <h1 class="mba-header"><strong>SPECIAL EXECUTIVE MASTERS PROGRAMME</strong> in <strong>Information Management</strong></h1>
                        ...
                        <div class="accordion mb-5" id="msbmAccordion">
                                ...
                                <div class="card-header" id="headingOne">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link btn-block" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                            SEMP in Information Management <i class="fa fa-chevron-down float-right"></i>
                                ...
                                <div id="collapseOne" class="collapse show" aria-labelledby="headingOne">
                                    <div class="card-body">
                                        <div class="wpb_wrapper">
                                            <p>New ways of using information and Internet-based and emerging technologies are revolutionizing the structure and operation of organizations. Today, information management enables integrated business processes that extend the entire information supply chain from consumer to provider to government to user. Corporate profitability and non-profits alike are transformed in ways we never imagined, and as a result enhance the effective delivery of public services.
                                                Staying competitive and productive in commercial business, non-profit and government demands a strategic response to the changes and innovations evolving from the collection of massive data repositories, rapidly emerging technologies, increased computing performance, increased communication capabilities and improved information dissemination and visualization.</p>
                            ...
                            <div class="card">
                                <div class="card-header" id="headingTwo">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link collapsed btn-block" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">Is the SEMP Information Management the right programme for me?<i class="fa fa-chevron-down float-right"></i>
                                            <i class="fa fa-chevron-up float-right"></i>
                                        </button>
                                    </h2>
                                </div>
                                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo">
                                    <div class="card-body">
                                        <div class="wpb_wrapper">
                                            <p>Our supported distance learning mode of delivery allows you to study online from any location and is designed to fit in around your work commitments. You will be taught and supported by experienced industry professionals who will recreate the same challenging interactive format of the on-campus courses for those studying at a distance.<br>
                                                Our virtual learning environment, offers students flexibility of where and when they can study, offering full and open access to tutors and other class members. Students have the benefit of being part of a group of learners with the invaluable opportunity to participate in active, group-related learning within a supportive online community setting. The online campus provides students with lectures and course materials and it also includes: Virtual tutorials, Live chat, Discussion forums – student and tutor led, Up-to-date web technology for delivery methods, User friendly material, Access to our online library.</p>
                                            <p>As online learners, students are part of a ‘virtual cohort’ and the communication and interaction amongst members of the cohort is a significant aspect of the learning process.</p>
                            ...
                            <div class="card">
                                <div class="card-header" id="headingThree">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link collapsed btn-block" type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                            Why SEMP Information Management? <i class="fa fa-chevron-down float-right"></i>
                                            <i class="fa fa-chevron-up float-right"></i>
                                        </button>
                                    </h2>
                                </div>
                                <div id="collapseThree" class="collapse" aria-labelledby="headingThree">
                                    <div class="card-body">
                                        <div class="wpb_wrapper">
                                            <p>• This program provides the practical skills and strategic mindset needed to become a successful reputation management professional<br>
                                                • Enhance your abilities to work more effectively with those who manage the reputation and brand<br>
                                                • World-class faculty bring an unparalleled depth of knowledge and real-world experience, which participants can draw upon in live Q&amp;A<br>
                                                • It is a virtual learning experience, so it won’t disrupt your normal work flow and there are no travel expenses<br>
                                                • Develop your network to help you address your own challenges and engage with peers throughout and after the program</p>
                            ...
                            <div class="card">
                                ...
                                <div id="collapseFour" class="collapse" aria-labelledby="headingFour">
                                    <div class="card-body">
                                        <div class="wpb_wrapper">
                                            <p>This online certificate program in Information Management, benefits professionals at all levels who want to contribute to their organization’s performance.</p>
                                            <p>Here are some of the people who will benefit from the online programme:<br>
                                                • Executives with responsibility for, corporate communications, and/or investor relations.<br>
                                                • Functional leaders who are involved with defining or executing brand and reputation strategies, such as leaders from human resources, public affairs, environmental relations, and legal<br>
                                                • Managers seeking to move into leadership positions in their organization<br>
                                                • Individuals seeking knowledge for career advancement in the field of Information management<br>
                                                • Cross-functional teams from within an organization can take the program, as that accelerates the impact and engenders a common language and understanding in the organization</p>
                            ...
                            <div class="card">
                                ...
                                <div id="collapseSeven" class="collapse" aria-labelledby="headingSeven">
                                    <div class="card-body">
                                        <p>Students who successfully complete the SEMP online programme will receive a Certificate SEMP in Information Management from the Metropolitan School of Business and Management UK.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="card">
                                ...
                                <div id="collapseFive" class="collapse" aria-labelledby="headingFive">
                                    <div class="card-body">
                                        <div class="wpb_wrapper">
                                            <p>• Introduction to Systems and Information<br>
                                                • Information Systems Strategy<br>
                                                • Information Systems Strategy Planning<br>
                                                • Strategic Information Tools and Strategic Advantage<br>
                                                • Organisational Knowledge<br>
                                                • Nomenclature of Contemporary ICT<br>
                                                • eCommerce and eBusiness<br>
                                                • Planning and Implementing eStrategy<br>
                                                • eSecurity<br>
                                                • Leveraging Knowledge Strategy<br>
                                                • Teleworking and Virtual Organisations<br>
                                                • Global Communities … K-Organisations</p>
