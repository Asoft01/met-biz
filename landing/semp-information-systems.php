...
<body>
    ...
    <div class="main-landing-page info-sys">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <div class="landing-position">
                            <div>
                                <h1 class="mba-header"><strong>SPECIAL EXECUTIVE MASTERS PROGRAMME</strong> in <strong>Information Systems</strong></h1>
                        ...
                        <div class="accordion mb-5" id="msbmAccordion">
                                ...
                                <div class="card-header" id="headingOne">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link btn-block" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                            SEMP in Information Systems <i class="fa fa-chevron-down float-right"></i>
                                ...
                                <div id="collapseOne" class="collapse show" aria-labelledby="headingOne">
                                    <div class="card-body">
                                        <div class="wpb_wrapper">
                                            <p>Information systems are the lifeblood of the modern enterprise, Information System Specialist have the power to create and restructure industries, empower individuals and firms, and dramatically reduce costs. As a result, organizations desperately need well-trained information systems specialists and technology-savvy managers. Today’s managers simply cannot effectively perform without a solid understanding of the role of information systems in organizations, competition, and society.<br>
                                                SEMP IS provides students with the knowledge and skills required to plan, develop, and deploy technology-based business solutions. Students are equipped with a solid understanding of the strategic role of information systems in organizations and the influential role of technology in society.</p>
                            ...
                            <div class="card">
                                <div class="card-header" id="headingTwo">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link collapsed btn-block" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">Is the SEMP Information Systems the right programme for me?<i class="fa fa-chevron-down float-right"></i>
                                            <i class="fa fa-chevron-up float-right"></i>
                                        </button>
                                    </h2>
                                </div>
                                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo">
                                    <div class="card-body">
                                        <p>Studying Information Systems will equip you to develop creative and innovative solutions to problems in government, businesses and non-profit organisations. You will learn how to work in creative teams to develop cutting-edge products and solutions that might save lives, improve the environment or our standard of living and keep us connected. You may choose to concentrate on the analysis of systems, the design of systems, or the use of information systems in organisations.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="card">
                                <div class="card-header" id="headingThree">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link collapsed btn-block" type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                            Why SEMP Information Systems? <i class="fa fa-chevron-down float-right"></i>
                                            <i class="fa fa-chevron-up float-right"></i>
                                        </button>
                                    </h2>
                                </div>
                                <div id="collapseThree" class="collapse" aria-labelledby="headingThree">
                                    <div class="card-body">
                                        <div class="wpb_wrapper">
                                            <p>It is impossible to think of any organization without the need for information. Through the use of computer technology, an information system provides the right information to the right person at the right time at the lowest possible cost. It is used at all levels of management from the operational to the strategic; it is also used in all functional areas of an organization. Because an information system helps an organization to be highly efficient as well as competitive, it is used in government and business organizations.</p>
                            ...
                            <div class="card">
                                ...
                                <div id="collapseFour" class="collapse" aria-labelledby="headingFour">
                                    <div class="card-body">
                                        <div class="wpb_wrapper">
                                            <p>This online certificate program in Information System, benefits professionals at all levels who want to contribute to their organization’s performance.<br>
                                                Here are some of the people who will benefit from the online programme:<br>
                            ...
                            <div class="card">
                                ...
                                <div id="collapseSeven" class="collapse" aria-labelledby="headingSeven">
                                    <div class="card-body">
                                        <p>Students who successfully complete the SEMP online programme will receive a Certificate SEMP in Strategic information System Analyst from the Metropolitan School of Business and Management UK.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="card">
                                ...
                                <div id="collapseFive" class="collapse" aria-labelledby="headingFive">
                                    <div class="card-body">
                                        <div class="wpb_wrapper">
                                            <p>• Managing Strategically I<br>
                                                • Managing Strategically II<br>
                                                • Managing Strategically III<br>
                                                • Management Information Systems<br>
                                                • Strategic Information Systems Planning I<br>
                                                • Strategic Information Systems Planning II<br>
                                                • Business/IS Strategy Alignment I<br>
                                                • Business/IS Strategy Alignment II<br>
                                                • eCommerce<br>
                                                • Investment in Strategic Information Systems<br>
                                                • Managing Information System Resources<br>
                                                • Procurement Options</p>
