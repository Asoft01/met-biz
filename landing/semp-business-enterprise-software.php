...
<body>
    ...
    <div class="main-landing-page bus-ent">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <div class="landing-position">
                            <div>
                                <h1 class="mba-header"><strong>SPECIAL EXECUTIVE MASTERS PROGRAMME</strong> in <strong>Business Enterprise Software</strong></h1>
                        ...
                        <div class="accordion mb-5" id="msbmAccordion">
                                ...
                                <div class="card-header" id="headingOne">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link btn-block" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                            SEMP in Business Enterprise Software <i class="fa fa-chevron-down float-right"></i>
                            ...
                            <div class="card">
                                <div class="card-header" id="headingTwo">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link collapsed btn-block" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">Is the SEMP Business Enterprise Software the right programme for me?<i class="fa fa-chevron-down float-right"></i>
                                            <i class="fa fa-chevron-up float-right"></i>
                                        </button>
                                    </h2>
                                </div>
                                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo">
                                    <div class="card-body">
                                        <p>Many organizations are embracing the use of business software to support their business priorities and objectives, and are implementing initiatives and programs to deploy business analytics across the enterprise. For these initiatives to succeed, organizations need to understand the key drivers that will facilitate the promotion and deployment of business analytics across the enterprise. The SEMP BES online program will provide an overview of the key organizational drivers and dimensions, and will explore how business software should be aligned to support the organization’s priorities. This online programme will also discuss the role and function for enterprise Business software centers of excellence and their types and mandates. The SEMP BES will provide a guideline for assessing your organization maturity, and for establishing a roadmap for an Enterprise Business Software Center of Excellence at your organization.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="card">
                                <div class="card-header" id="headingThree">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link collapsed btn-block" type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                            Why SEMP Business Enterprise Software? <i class="fa fa-chevron-down float-right"></i>
                                            <i class="fa fa-chevron-up float-right"></i>
                                        </button>
                                    </h2>
                                </div>
                            ...
                            <div class="card">
                                ...
                                <div id="collapseNine" class="collapse" aria-labelledby="headingNine">
                                    <div class="card-body">
                                        <div class="wpb_wrapper">
                                            <p>This online certificate program in Information System, benefits professionals at all levels who want to contribute to their organization’s performance.</p>
                                            <p>Here are some of the people who will benefit from the online programme:</p>
                                            <p>• Cross-functional teams from within an organization can take the program, as that accelerates the impact and engenders a common language and understanding in the organization<br>
                                                • I.T Managers<br>
                                                • Business owners in the I.T Industry<br>
                                                • IT Trainers</p>
                            ...
                            <div class="card">
                                ...
                                <div id="collapseFour" class="collapse" aria-labelledby="headingFour">
                                    <div class="card-body">
                                        <div class="wpb_wrapper">
                                            <p>Students who successfully complete the SEMP online programme will receive a Certificate SEMP in Enterprise Software and Business Infrastructure from the Metropolitan School of Business and Management UK.</p>
                            ...
                            <div class="card">
                                ...
                                <div id="collapseFive" class="collapse" aria-labelledby="headingFive">
                                    <div class="card-body">
                                        <div class="wpb_wrapper">
                                            <ul>
                                                <li>Introduction to Enterprise Systems and Organisations</li>
                                                <li>Reference Models and Business Architecture</li>
                                                <li>Reference Models and Business Architecture Part 2</li>
                                                <li>IT Infrastructure and Administration of Enterprise Systems</li>
                                                <li>IT Infrastructure and Administration of Enterprise Systems Part 2</li>
                                                <li>Enterprise Software Systems</li>
                                                <li>Enterprise Software Systems Part 2</li>
                                                <li>Enterprise System Software</li>
                                                <li>Business Process Management</li>
                                                <li>EAI, SOA and Web Services</li>
