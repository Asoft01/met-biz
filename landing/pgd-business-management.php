...
<body>
    ...
    <div class="main-landing-page ipgd-bm">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <div class="landing-position">
                            <div>
                                <h1 class="mba-header">Earn an Affordable, Flexible & Accredited <strong>International Postgraduate Diploma in Business and Management</strong> (Level 7)</h1>
                        ...
                        <div class="accordion mb-5" id="msbmAccordion">
                            <div class="card">
                                <div class="card-header" id="headingOne">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link btn-block" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                            International Postgraduate Diploma in Business and Management <i class="fa fa-chevron-down float-right"></i>
                                ...
                                <div id="collapseOne" class="collapse show" aria-labelledby="headingOne">
                                    <div class="card-body">
                                        The course equips learners to be a confident, creative, and capable manager, well versed in all management and business functions, with the flexibility to see situations from a fresh perspective. This course builds on a critical perspective that enables learners to navigate the business world in the 21st century.
                                    </div>
                                </div>
                            </div>
                            <div class="card">
                                        ...
                                        <div class="wpb_wrapper">
                                            ...
                                            <table class="table table-striped">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td width="482">Entrepreneurship and Business Development</td>
                                                        <td width="155">20</td>
                                                    </tr>
                                                    <tr>
                            ...
                            <div class="card">
                                ...
                                <div id="collapseFour" class="collapse" aria-labelledby="headingFour">
                                    <div class="card-body">
                                        <div class="wpb_wrapper">
                                            <p>The MSBM Level 7 Diploma in Business and Management programme enables learners to progress into or within employment and/or continue their further study by topping up the degree with Masters in Business Administration at certain Universities in the UK.</p>
                                ...
                                <div class="card-header" id="headingSix">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link collapsed btn-block" type="button" data-toggle="collapse" data-target="#collapseSix" aria-expanded="false" aria-controls="collapseSix">
                                            Module 1: ENTREPRENEURSHIP AND BUSINESS DEVELOPMENT <i class="fa fa-chevron-down float-right"></i>
                                            <i class="fa fa-chevron-up float-right"></i>
                                        </button>
                                    </h2>
                                </div>
                                <div id="collapseSix" class="collapse" aria-labelledby="headingSix">
                                    <div class="card-body">
                                        <div class="wpb_wrapper">
                                            ...
                                            <p>This unit aims to provide learners with an understanding of the theory and practice of entrepreneurship in a range of organisational context. It also encourages learners to develop a critical appreciation of current academic debates on entrepreneurship and other closely related concepts.</p>
                                            <p><strong>Learning Outcomes</strong></p>
                                            <ol>
                                                <li>Be able to identify the characteristics of the entrepreneur in relation to the organisational success and failure.</li>
                                                <li>Be able to identify skills required to generate new business ideas</li>
                                                <li>Be able to perform external analysis of new business plan to gain competitive advantage</li>
                                                <li>Be able to understand the importance of financial and accounting techniques for enterprise development and business planning</li>
                                                <li>Be able to understand legal obligations and importance of rules and regulation to a new business.</li>
                                            </ol>
                                ...
                                <div class="card-header" id="headingSeven">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link collapsed btn-block" type="button" data-toggle="collapse" data-target="#collapseSeven" aria-expanded="false" aria-controls="collapseSeven">
                                            Module 2: STRATEGIC FINANCIAL MANAGEMENT <i class="fa fa-chevron-down float-right"></i>
                                            <i class="fa fa-chevron-up float-right"></i>
                                        </button>
                                    </h2>
                                </div>
                                ...
                                <div class="card-header" id="headingEight">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link collapsed btn-block" type="button" data-toggle="collapse" data-target="#collapseEight" aria-expanded="false" aria-controls="collapseEight">
                                            Module 3: STRATEGIC MANAGEMENT <i class="fa fa-chevron-down float-right"></i>
                                            <i class="fa fa-chevron-up float-right"></i>
                                        </button>
                                    </h2>
                                </div>
                                ...
                                <div class="card-header" id="headingEleven">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link collapsed btn-block" type="button" data-toggle="collapse" data-target="#collapseEleven" aria-expanded="false" aria-controls="collapseEleven">
                                            Module 4: STRATEGIC Business and Management <i class="fa fa-chevron-down float-right"></i>
                                            <i class="fa fa-chevron-up float-right"></i>
                                        </button>
                                    </h2>
                                </div>
