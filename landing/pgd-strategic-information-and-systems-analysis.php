...
<body>
    ...
    <div class="main-landing-page pgd-sa">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <div class="landing-position">
                            <div>
                                <h1 class="mba-header">Earn an Affordable, Flexible & Accredited <strong>International Postgraduate Diploma in Strategic Information and Systems Analysis</strong> (Level 7)</h1>
                        ...
                        <div class="accordion mb-5" id="msbmAccordion">
                            <div class="card">
                                <div class="card-header" id="headingOne">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link btn-block" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                            International Postgraduate Diploma in Strategic Information and Systems Analysis <i class="fa fa-chevron-down float-right"></i>
                                ...
                                <div id="collapseOne" class="collapse show" aria-labelledby="headingOne">
                                    <div class="card-body">
                                        <p>The International Postgraduate Diploma in Strategic Information and Systems Analysis prepares candidates to become specialists in the Information Technology sector so they can meet the needs of modern businesses, especially at the middle levels of organisations. It is designed to meet the increasing demand in the work place for IT professionals with a wide knowledge of business management, technical skills and the capacity to offer support in the implementation of IT-based solutions in a business environment.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="card">
                            ...
                            <div class="card">
                                ...
                                <div id="collapseFour" class="collapse" aria-labelledby="headingFour">
                                    <div class="card-body">
                                        <div class="wpb_wrapper">
                                            <p>The MSBM Level International Postgraduate Diploma in Strategic Information and Systems Analysis programme enables learners to progress into or within employment and/or continue their further study by topping up the degree with Masters in Information Technology Management at certain Universities in the UK.</p>
                                ...
                                <div class="card-header" id="headingSix">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link collapsed btn-block" type="button" data-toggle="collapse" data-target="#collapseSix" aria-expanded="false" aria-controls="collapseSix">
                                            Module 1: SYSTEM ANALYSIS AND DESIGN <i class="fa fa-chevron-down float-right"></i>
                                            <i class="fa fa-chevron-up float-right"></i>
                                        </button>
                                    </h2>
                                </div>
                                ...
                                <div class="card-header" id="headingSeven">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link collapsed btn-block" type="button" data-toggle="collapse" data-target="#collapseSeven" aria-expanded="false" aria-controls="collapseSeven">
                                            Module 2: DATABASE MANAGEMENT SYSTEMS <i class="fa fa-chevron-down float-right"></i>
                                            <i class="fa fa-chevron-up float-right"></i>
                                        </button>
                                    </h2>
                                </div>
                                ...
                                <div class="card-header" id="headingEight">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link collapsed btn-block" type="button" data-toggle="collapse" data-target="#collapseEight" aria-expanded="false" aria-controls="collapseEight">
                                            Module 3: MANAGEMENT INFORMATION SYSTEMS <i class="fa fa-chevron-down float-right"></i>
                                            <i class="fa fa-chevron-up float-right"></i>
                                        </button>
                                    </h2>
                                </div>
                                ...
                                <div class="card-header" id="headingEleven">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link collapsed btn-block" type="button" data-toggle="collapse" data-target="#collapseEleven" aria-expanded="false" aria-controls="collapseEleven">
                                            Module 4: INFORMATION SYSTEMS DEVELOPMENT <i class="fa fa-chevron-down float-right"></i>
                                            <i class="fa fa-chevron-up float-right"></i>
                                        </button>
                                    </h2>
                                </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <p class="foot-disclaimer">
                        Disclaimer: * The logo, name and its products and services are the trademarks of Metropolitan School of Strategic Information and Systems Analysis London, UK . All other company names, brand names, trademarks and logos mentioned on this website are the property of their respective owners and do not constitute or imply endorsement, sponsorship or recommendation by the respective trademark owner.
                    </p>
                </div>
            </div>
        </div>
