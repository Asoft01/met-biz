...
<body>
    ...
    <div class="main-landing-page bus-admin">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <div class="landing-position">
                            <div>
                                <h1 class="mba-header"><strong>SPECIAL EXECUTIVE MASTERS PROGRAMME</strong> in <strong>Business Administration</strong></h1>
                        ...
                        <div class="accordion mb-5" id="msbmAccordion">
                                ...
                                <div class="card-header" id="headingOne">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link btn-block" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                            SEMP in Business Administration <i class="fa fa-chevron-down float-right"></i>
                                ...
                                <div id="collapseOne" class="collapse show" aria-labelledby="headingOne">
                                    <div class="card-body">
                                        <div class="wpb_wrapper">
                                            <div class="wpb_wrapper">
                                                <p>Economic knowledge and good administration is crucial to prosperity and progress in a modern society. For both customers and employees, it is important that companies and public institutions are administered well. At the same time, good administration has significant impact on a company’s bottom line figures. One of the key words in Business Administration is management, and as an SEMP BA student, you will gain insight into both financial and psychological aspects of management. The online programme will provide you with a wide range of skills that will qualify you for many different positions in the public or private sectors.</p>
                            ...
                            <div class="card">
                                <div class="card-header" id="headingTwo">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link collapsed btn-block" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">Is the SEMP Business Administration the right programme for me?<i class="fa fa-chevron-down float-right"></i>
                                            <i class="fa fa-chevron-up float-right"></i>
                                        </button>
                                    </h2>
                                </div>
                                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo">
                                    <div class="card-body">
                                        <div class="wpb_wrapper">
                                            <p>SEMP Business Administration program emphasizes preparation for practical decision making in a business environment. The online program will prepare you for a career in business. Students develop specialized skills and improve their capacity to analyze, communicate effectively with associates, think independently and thrive in work situations.</p>
                            ...
                            <div class="card">
                                <div class="card-header" id="headingThree">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link collapsed btn-block" type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                            Why SEMP Business Administration? <i class="fa fa-chevron-down float-right"></i>
                                            <i class="fa fa-chevron-up float-right"></i>
                                        </button>
                                    </h2>
                                </div>
                                <div id="collapseThree" class="collapse" aria-labelledby="headingThree">
                                    <div class="card-body">
                                        <div class="wpb_wrapper">
                                            <p>The courses in Business Administration will provide you with insight in Organisational theory, management psychology, marketing, planning, micro economics and cost management. You will learn how to locate and analyze management issues, such as how to increase customer satisfaction; you will also learn to understand how companies and institutions are influenced by international conditions, technology, global economy or legislation.</p>
                            ...
                            <div class="card">
                                ...
                                <div id="collapseNine" class="collapse" aria-labelledby="headingNine">
                                    <div class="card-body">
                                        <div class="wpb_wrapper">
                                            <p>The SEMP Business Administration programme is designed for entry-level managers, up to mid-level managers, senior managers or directors, consultant who are in general management role or fast approaching such position and is seeking an opportunity to obtain a richer, deeper understanding of management skills.<br>
                                                The SEMP Business Administration Certificate Program is ideal for professionals of all levels. This program provides the practical skills to overcome daily challenges by providing participants the latest in administration principles and techniques.</p>
                            ...
                            <div class="card">
                                ...
                                <div id="collapseFour" class="collapse" aria-labelledby="headingFour">
                                    <div class="card-body">
                                        <div class="wpb_wrapper">
                                            <p>Students who successfully complete the SEMP online programme will receive a Certificate SEMP in Business Administration (SEMP MBA) from the Metropolitan School of Business and Management UK.</p>
                            ...
                            <div class="card">
                                ...
                                <div id="collapseFive" class="collapse" aria-labelledby="headingFive">
                                    <div class="card-body">
                                        <div class="wpb_wrapper">
                                            <p>• Introduction to Strategic Management<br>
                                                • Environmental Analysis<br>
                                                • Strategic Management and Industry Analysis<br>
                                                • Strategic Management and Analysis of Strategic Capability<br>
                                                • Strategic Management and Strategic Direction and Competitive Strategies<br>
                                                • Strategic Management and Leadership Management<br>
                                                • Motivation<br>
                                                • Teams<br>
                                                • Introduction to Marketing Management<br>
