...
<body>
    ...
    <div class="main-landing-page semp">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <div class="landing-position">
                            <div>
                                <h1 class="numero-uno"> <strong>SEMP Global Business Strategy</strong> for Business Executives</h1>
                                <p class="sub-numero-uno">We are a world class business school located in the heart of London, Dubai, Muscat and Lagos.<br /> We are one of the fastest growing British business schools with a stylish blended<br /> learning model that is both online and on campus.</p>
                            </div>
                        </div>
                        <!-- <h3 class="sub-numero-uno">BENEFITS:</h3>
                            <ul class="header-list header-list-sm">
                                <li>Buffet and Tea breaks</li>
                                <li>Lecturers from MSBM International</li>
                                <li>Study Materials</li>
                                <li>Practical Business Case-studies</li>
                                <li>MSBM Reference</li>
                                <li>Course Transcript</li>
                                <li>Certificate from MSBM UK</li>
...
<!--
        ...
        <section class="final-landing why_msbm">
            <div class="container">
                <h2 class="">5 Days of Learning and Luxury</h2>
        ...
        <div class="why_msbm why-content landing-features landing-main-grey">
            <div class="container">

                <div class="row">
                    <div class="col-lg-10 mx-auto">
                        <h2 class="text-center">What makes us different ?</h2>
                        <p class="padd-both text-center">Global business strategy as a programme with the Metropolitan School of Business and Management addresses these questions: what must be (versus what is) the extent of market presence in the world's major markets? How to build the necessary global presence? What must be AND (versus what is) the optimal locations around the world for the various value chain activities? How to run global presence into global competitive advantage?</p>
                        <p class="padd-both text-center">Leaders seek ways to map out a business plan, create strategy in a competitive market, expand into new markets, execute business buyouts or mergers and create a company from scratch. After all said and done then comes the most important part getting the right people to build and manage an enterprise and the acquiring the resources to fuel it.</p>
                        <p class="padd-both text-center">As a leader in Senior Management Development Training, MSBM has developed this programme as a short workshop format using the Core Principles of a Business School MBA in Leadership. This format allows delegates to overcome their day-to-day operational demands and focus on developing themselves and their business.</p>
                        <br />
                    </div>
                </div>
        ...
        <div class="attend-landing why_msbm">
            <div class="container">

                <div class="row">
                    <div class="col-lg-10 mx-auto">
                        <h2 class="text-center">Who should attend?</h2>
                        <p class="text-center">MD/CEOs <strong>|</strong> Entrepreneurs or Leaders <strong>|</strong> Managers <strong>|</strong> Directors</p>
                        <p class="text-center">The programme is designed for any senior manager or director, who is in a general management role or fast approaching such position.</p>
                        <p class="text-center">The Global Business Strategy Programme is accredited by the Metropolitan School of Business and Management United Kingdom and the certificates will be presented by our UK campus. At the end of the programme student will be expected to have gained vital knowledge on Entrepreneurship for SMEs, corporations, start-ups and be able to successfully turn businesses into what they envisioned.</p>
                        <br />
                    </div>
                </div>
        ...
        <div class="landing-cta text-center">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <h2 class="text-center">For Registration</h2>
                        <strong class="land-num">057 767 0880 or 057 767 0881</strong>
                ...
                <div class="row text-center">
                    <div class="col-lg-4">
                        <div class="user-testify">
                            ...
                            <p>
                                <i>"The programme provides you with the support, confidence and knowledge to accelerate your entrepreneurial journey regardless of the stage which you are at."</i>
                            </p>
                            <p>IMAFIDON C., Alumni</p>
        ...
        <!-- <div class="logo-banner branded landing-brand">
            <div class="container">
                <h5 class="client-heading">GRADUATES FROM MSBM MASTERS PROGRAMME ARE <br />FROM COMPANIES SUCH AS</h5>
                <div class="row text-center">
