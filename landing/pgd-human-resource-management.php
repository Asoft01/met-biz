...
<body>
    ...
    <div class="main-landing-page pgd-hm">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <div class="landing-position">
                            <div>
                                <h1 class="mba-header">Earn an Affordable, Flexible & Accredited <strong>International Postgraduate Diploma in Human Resource Management</strong> (Level 7)</h1>
                        ...
                        <div class="accordion mb-5" id="msbmAccordion">
                                ...
                                <div class="card-header" id="headingOne">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link btn-block" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                            International Postgraduate Diploma in Human Resource Management <i class="fa fa-chevron-down float-right"></i>
                                        ...
                                        <div class="wpb_wrapper">
                                            ...
                                            <table class="table table-striped">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td width="482">Performance Management</td>
                                                        <td width="155">20</td>
                                                    </tr>
                                                    <tr>
                                                        <td width="482">Employee Relations</td>
                                                        <td width="155">20</td>
                                                    </tr>
                                                    <tr>
                                                        <td width="482">Strategic Human Resource Management and Development</td>
                                                        <td width="155">20</td>
                                                    </tr>
                                                    <tr>
                                                        <td width="482">Leading, Managing and Human Resource Development</td>
                                                        <td width="155">20</td>
                                                    </tr>
                                                    <tr>
                                                        <td width="482">Resourcing, Talent Management and Development</td>
                                                        <td width="155">20</td>
                                                    </tr>
                                                    <tr>
                                                        <td width="482">Contemporary Human Resource Management</td>
                                                        <td width="155">20</td>
                                                    </tr>
                                                    <tr>
                            ...
                            <div class="card">
                                ...
                                <div id="collapseFour" class="collapse" aria-labelledby="headingFour">
                                    <div class="card-body">
                                        <div class="wpb_wrapper">
                                            <p>The MSBM Level 7 Diploma in Human Resource Management programme enables learners to progress into or within employment and/or continue their further study by topping up the degree with Masters in Human Resource Management at certain Universities in the UK.</p>
                                ...
                                <div class="card-header" id="headingSix">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link collapsed btn-block" type="button" data-toggle="collapse" data-target="#collapseSix" aria-expanded="false" aria-controls="collapseSix">
                                            Module 1: PERFORMANCE MANAGEMENT UNIT <i class="fa fa-chevron-down float-right"></i>
                                            <i class="fa fa-chevron-up float-right"></i>
                                        </button>
                                    </h2>
                                </div>
                                <div id="collapseSix" class="collapse" aria-labelledby="headingSix">
                                    <div class="card-body">
                                        <div class="wpb_wrapper">
                                            ...
                                            <p>To enable learners to understand how to describe performance management and its role in running an effective organizational. Learner will understand the main elements that influence the performance of employees at all levels within an organisation and the ways in which such elements can be managed in a constructive manner. Further to provide learners with understanding to devise and implement appropriate HR practices and strategies that relate to Performance Management.</p>
                                            <p><strong>Learning Outcomes</strong></p>
                                            <ol>
                                                <li>Understand the relationship between Human Resource practices and Organisational Performance.</li>
                                                <li>Be able to identify the barriers and blockages preventing expected standards of performance being met.</li>
                                                <li>Be able to analyze the key HR and employment practices influencing employee performance.</li>
                                                <li>Understand the key requirements of various systems central to performance management and their integration.</li>
                                            </ol>
                            ...
                            <div class="card">
                                <div class="card-header" id="headingSeven">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link collapsed btn-block" type="button" data-toggle="collapse" data-target="#collapseSeven" aria-expanded="false" aria-controls="collapseSeven">
                                            Module 2: EMPLOYEE RELATIONS <i class="fa fa-chevron-down float-right"></i>
                                            <i class="fa fa-chevron-up float-right"></i>
                                        </button>
                                    </h2>
                                </div>
                                <div id="collapseSeven" class="collapse" aria-labelledby="headingSeven">
                                    <div class="card-body">
                                        <div class="wpb_wrapper">
                                            <p><strong>Module Aim</strong></p>
                                            <p>The aim of this unit is to introduce learners to the importance of good employee relations for business success and the impact of changes which have affected employment relationships. Competencies required by HRM professionals in designing, implementing and evaluating employment relations strategies, plans, policies, systems and procedures to mitigate organisational risk, support organisational performance and meet the organisation’s business goals will be discussed. Also to develop the ability to make remedies to current/ potential conflict situations in compliance to legal and ethical considerations.</p>
                                            <p><strong>Learning Outcomes</strong></p>
                                            <ol>
                                                <li>Understand the context of employee relations against a changing background.</li>
                                                <li>Be able to analyse the impact of local, national and international contextual factors on the employment relationship.</li>
                                                <li>Understand the importance of employee relations on organisational performance.<br>
                                                    To see the different perspectives of the parties to employee relations at organisation, industry and national levels</li>
                                                <li>To be able to give professional advice on the formulation and implementation of employee relations policy.</li>
                                                <li>To appreciate the strategic nature of employee relations and it’s contribution to organisational success.</li>
                                            </ol>
                            ...
                            <div class="card">
                                <div class="card-header" id="headingEight">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link collapsed btn-block" type="button" data-toggle="collapse" data-target="#collapseEight" aria-expanded="false" aria-controls="collapseEight">
                                            Module 3: STRATEGIC HUMAN RESOURCE MANAGEMENT AND DEVELOPMENT <i class="fa fa-chevron-down float-right"></i>
                                            <i class="fa fa-chevron-up float-right"></i>
                                        </button>
                                    </h2>
                                </div>
                                <div id="collapseEight" class="collapse" aria-labelledby="headingEight">
                                    <div class="card-body">
                                        <div class="wpb_wrapper">
                                            <p><strong>Module Aim</strong></p>
                                            <p>The learner will gain an understanding of how the effective strategic management of human resources supports the achievement of organisational purposes in different organizational context. The unit seeks to analyze and evaluate the contribution of strategic human resource management to competitive advantage</p>
                                            <ol>
                                                <li>Critically analyze the role of strategic management of human resources</li>
                                                <li>Evaluate human resource planning in an organisation.</li>
                                                <li>Critically discuss the role of legal, ethical issue in developing human resources policy.</li>
                                                <li>Plan effective human resource strategies</li>
                                                <li>Critically analyze Leadership and Management theory</li>
                                            </ol>
                            ...
                            <div class="card">
                                <div class="card-header" id="headingEleven">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link collapsed btn-block" type="button" data-toggle="collapse" data-target="#collapseEleven" aria-expanded="false" aria-controls="collapseEleven">
                                            Module 4: RESOURCING, TALENT MANAGEMENT AND DEVELOPMENT <i class="fa fa-chevron-down float-right"></i>
                                            <i class="fa fa-chevron-up float-right"></i>
                                        </button>
                                    </h2>
                                </div>
                                <div id="collapseEleven" class="collapse" aria-labelledby="headingEleven">
                                    <div class="card-body">
                                        <div class="wpb_wrapper">
                                            <p><strong>Module Aim</strong></p>
                                            <p>The purpose of this unit is to develop competence in understanding and analysing employment markets and demographic trends to create and implement effective, ethical and appropriate resourcing, retention, talent management and development strategies. Also the potential and limitations of the contribution of learning and talent development policies and strategies to formulating and achieving objectives at national, organisational, group and individual level will be discussed. Learners will assess the role of HRM professionals in designing, implementing and evaluating strategic planning relevant to employee resourcing, talent management and development.</p>
                                            <p><strong>Learning Outcomes</strong></p>
                                            <ol>
                                                <li>Understand the theoretical and conceptual basis for employee resourcing and major contemporary developments in employee resourcing and talent management.</li>
                                                <li>Understand the features and characteristics of changing employment markets as a basis for effective resourcing and talent management strategies.</li>
                                                <li>Understand the full range of professional functions associated with long and short term talent and succession planning.</li>
                                                <li>Understand the theoretical and conceptual basis of learning and talent development and contemporary research evidence.</li>
                                                <li>Be able to design, implement and evaluate resourcing and talent management and development strategies.</li>
                                            </ol>
                            ...
                            <div class="card">
                                <div class="card-header" id="headingNine">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link collapsed btn-block" type="button" data-toggle="collapse" data-target="#collapseNine" aria-expanded="false" aria-controls="collapseNine">
                                            Module 5: LEADING, MANAGING AND HUMAN RESOURCE DEVELOPMENT <i class="fa fa-chevron-down float-right"></i>
                                            <i class="fa fa-chevron-up float-right"></i>
                                        </button>
                                    </h2>
                                </div>
                                <div id="collapseNine" class="collapse" aria-labelledby="headingNine">
                                    <div class="card-body">
                                        <div class="wpb_wrapper">
                                            <p><strong>Module Aim</strong></p>
                                            <p>To provide learners with the competence to proffer solutions to problems arising in relation to leadership, management and development of human resource within the organisational contexts. Learners will be enabled to appraise the effectiveness of organisational strategies, processes and practices in efficient and effective leadership and management, also the contribution of HRM/HRD practitioners to organisational change.</p>
                                            <p><strong>Learning Outcomes</strong></p>
                                            <ol>
                                                <li>Understand the theoretical and conceptual basis for HRM and HRD in organisations and major contemporary developments in this area.</li>
                                                <li>Understand the nature of leadership and its contribution to individual, group and organisational development.</li>
                                                <li>Be able to evaluate the contribution of HRM and HRD functions in an organisation.</li>
                                                <li>Be able to promote professionalism and ethical approach to HRM and HRD practice in organisations.</li>
                                                <li>Understand how to promote a flexible working environment and effective change management practices.</li>
                                            </ol>
                            ...
                            <div class="card">
                                <div class="card-header" id="headingTen">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link collapsed btn-block" type="button" data-toggle="collapse" data-target="#collapseTen" aria-expanded="false" aria-controls="collapseTen">
                                            Module 6: CONTEMPORARY HUMAN RESOURCE MANAGEMENT <i class="fa fa-chevron-down float-right"></i>
                                            <i class="fa fa-chevron-up float-right"></i>
                                        </button>
                                    </h2>
                                </div>
                                <div id="collapseTen" class="collapse" aria-labelledby="headingTen">
                                    <div class="card-body">
                                        <div class="wpb_wrapper">
                                            <p><strong>Module Aim</strong></p>
                                            <p>To provide learners with the ability to understand and analyze the impact of internal and external environmental forces on organisational strategy and management of people. Also to enable the learner to analyze a range of organisational contexts and how they develop ways to respond such environmental forces and the role of HR professionals in contributing to it.</p>
                                            <p><strong>Learning Outcomes</strong></p>
                                            <ol>
                                                <li>Understand the environment of modern organisations and changing nature of contemporary HRM.</li>
                                                <li>Understand the impact of changes to the structure and nature of industry, employment law and working patterns on HRM.</li>
                                                <li>Understand the process of strategic management and the role of HR professionals in contributing to it.</li>
                                                <li>Understand the diverse application of HR practices in a range of organisational contexts</li>
                                            </ol>
        ...
        <div class="logo-banner branded landing-brand">
            <div class="container">
                <h5 class="client-heading">MSBM PARTICIPANTS ARE FROM COMPANIES SUCH AS</h5>
                <div class="row text-center">
                    <!-- <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-12">
                    <p class="foot-disclaimer">
                        Disclaimer: * The logo, name and its products and services are the trademarks of Metropolitan School of Human Resource Management London, UK . All other company names, brand names, trademarks and logos mentioned on this website are the property of their respective owners and do not constitute or imply endorsement, sponsorship or recommendation by the respective trademark owner.
                    </p>
                </div>
            </div>
        </div>
