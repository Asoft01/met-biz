...
<body>
    ...
    <div class="main-landing-page proj">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <div class="landing-position">
                            <div>
                                <h1 class="mba-header"><strong>SPECIAL EXECUTIVE MASTERS PROGRAMME</strong> in <strong>Project Management</strong></h1>
                        ...
                        <div class="accordion mb-5" id="msbmAccordion">
                                ...
                                <div class="card-header" id="headingOne">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link btn-block" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                            SEMP in Project Management <i class="fa fa-chevron-down float-right"></i>
                                ...
                                <div id="collapseOne" class="collapse show" aria-labelledby="headingOne">
                                    <div class="card-body">
                                        <div class="wpb_wrapper">
                                            <p>In today’s challenging economic environment, project managers, senior management and professional, needs to understand the fundamental supportive and strategic role that project management plays in business. If companies are to pursue their plans for stability and growth they need to cease seeing project management as a functional activity and place it at the core of their business processes. At the same time, project managers and planners share the responsibility to engage better on a business basis with senior executives.</p>
                            ...
                            <div class="card">
                                <div class="card-header" id="headingTwo">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link collapsed btn-block" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">Is the SEMP Project Management the right programme for me?<i class="fa fa-chevron-down float-right"></i>
                                            <i class="fa fa-chevron-up float-right"></i>
                                        </button>
                                    </h2>
                                </div>
                                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo">
                                    <div class="card-body">
                                        <div class="wpb_wrapper">
                                            <p>Some project managers train specifically for a professional role in project management right from the start, whilst others progress through their organization in different roles, and at some point identify project management as a role they would like to take on. Sometimes it is a role that you fall into by accident or one that is thrust upon you; so practical experience is often gained before becoming certified.<br>
                                                If you are contemplating a career change then there are several things you should consider. Firstly you must consider if you think you have the right sort of personality to become a project manager, for instance:</p>
                                            <p>• Are you comfortable taking the lead role in a high-pressure situation?<br>
                                                • Have you got the ability to effectively manage resources on a large scale?<br>
                                                • Can you think on your feet and quickly react to change?<br>
                                                • Do you have good problem solving skills?<br>
                                                • Do you have the experience with finance to manage large budgets?<br>
                                                • Can you be honest, and say ‘No’ to staff and management when required?<br>
                                                • Can you be decisive when required, and accept responsibility for your decisions?</p>
                                            <p>If you answered yes to most of these questions then a career in project management is definitely worth considering. As long as you’re proficient in most of the above, you can learn the remaining aspects through good additional training.</p>
                            ...
                            <div class="card">
                                <div class="card-header" id="headingThree">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link collapsed btn-block" type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                            Why SEMP Project Management? <i class="fa fa-chevron-down float-right"></i>
                                            <i class="fa fa-chevron-up float-right"></i>
                                        </button>
                                    </h2>
                                </div>
                                <div id="collapseThree" class="collapse" aria-labelledby="headingThree">
                                    <div class="card-body">
                                        <div class="wpb_wrapper">
                                            <p>SEMP PM provides benefits to the managers and directors of a project and to an Organization, through the controllable use of resources and the ability to manage business and project risk more effectively.<br>
                                                SEMP PM embodies established and proven best practice in project management. It is widely recognized and understood, providing a common language for all participants in a project.<br>
                                                SEMP PM encourages formal recognition of responsibilities within a project and focuses on what a project is to deliver, why, when and for whom.</p>
                            ...
                            <div class="card">
                                ...
                                <div id="collapseFour" class="collapse" aria-labelledby="headingFour">
                                    <div class="card-body">
                                        <div class="wpb_wrapper">
                                            <p>Whether you are in construction management; project execution; or project, program, or portfolio management, this could be an ideal program for you if you are looking for career development opportunities to enhance your knowledge and skill sets in managing large, complex projects. Also, here of some of the people that can register for the online programme.</p>
                                            <p>• project manager<br>
                                                • assistant project manager<br>
                                                • project management associate<br>
                                                • project coordinator<br>
                                                • project planner<br>
                                                • project change management analyst</p>
                                            <p>There is no strict requirement for this programme as it is a non-credit bearing programme.<br>
                                                Participants have the option to attend the school graduation ceremony in Dubai.</p>
                            ...
                            <div class="card">
                                ...
                                <div id="collapseSeven" class="collapse" aria-labelledby="headingSeven">
                                    <div class="card-body">
                                        <p>Students who successfully complete the SEMP online programme will receive a Certificate SEMP in Project Management from the Metropolitan School of Business and Management UK.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="card">
                                ...
                                <div id="collapseFive" class="collapse" aria-labelledby="headingFive">
                                    <div class="card-body">
                                        <div class="wpb_wrapper">
                                            <p>• An Introduction to Projects and Project Management – Part 1<br>
                                                • An introduction to Project and Project Management (Project Stake holders) – Part 2<br>
                                                • Project Initiation<br>
                                                • Project Selection<br>
                                                • Quality Assurance<br>
                                                • Work Breakdown Structures and Estimating<br>
                                                • Project Process and the Project Office<br>
                                                • Project Planning<br>
                                                • Microsoft Project and Resource Levelling<br>
                                                • Managing the Project Team (Team Structures and Organisation) – Part 1<br>
                                                • Managing the Project Team (Project Manager’s Responsibility) – Part 2<br>
                                                • Monitoring and Controlling Projects<br>
                                                • Project Closure<br>
                                                • Software/Project Maturity Model (Managing Change) – Part 1<br>
                                                • Software/ Project Maturity Model ( Capability Model) – Part 2</p>
