...
<body>
    ...
    <div class="main-landing-page rmethod">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <div class="landing-position">
                            <div>
                                <h1 class="mba-header"><strong>SPECIAL EXECUTIVE MASTERS PROGRAMME</strong> in <strong>Research Methodology</strong></h1>
                        ...
                        <div class="accordion mb-5" id="msbmAccordion">
                                ...
                                <div class="card-header" id="headingOne">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link btn-block" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                            SEMP in Research Methodology <i class="fa fa-chevron-down float-right"></i>
                                ...
                                <div id="collapseOne" class="collapse show" aria-labelledby="headingOne">
                                    <div class="card-body">
                                        <div class="wpb_wrapper">
                                            <p>Research Methodology is the most commonly recognized and utilized social science for studying large populations. Demand is growing worldwide for professionals who can influence social issues and conditions by conducting surveys, analyzing data and reporting results. Help fill the growing need and enhance your career with SEMP Research Methodology online certificate program.</p>
                            ...
                            <div class="card">
                                <div class="card-header" id="headingTwo">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link collapsed btn-block" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">Is the SEMP Research Methodology the right programme for me?<i class="fa fa-chevron-down float-right"></i>
                                            <i class="fa fa-chevron-up float-right"></i>
                                        </button>
                                    </h2>
                                </div>
                                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo">
                                    <div class="card-body">
                                        <div class="wpb_wrapper">
                                            <p>For any blossoming or flourishing business, by doing research, you are arming yourself with crucial information that will allow you to make informed business decisions. You need to find out about your competition, how successful they are, what they do and don’t offer, how you may be able to fill the gaps in their offering, all to give your business a competitive advantage. Research Methodology will enable students to relate business to such area as identifying your target customer, marketplace trends, production processes, and financial practices, can help you predict trends, project sales, spot opportunities, and avoid potential problems. Understanding the nature of different types of business research will help you use data to maximize your sales and profits.</p>
                            ...
                            <div class="card">
                                <div class="card-header" id="headingThree">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link collapsed btn-block" type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                            Why SEMP Research Methodology? <i class="fa fa-chevron-down float-right"></i>
                                            <i class="fa fa-chevron-up float-right"></i>
                                        </button>
                                    </h2>
                                </div>
                                <div id="collapseThree" class="collapse" aria-labelledby="headingThree">
                                    <div class="card-body">
                                        <div class="wpb_wrapper">
                                            <p>The Survey Research Methods online certificate program is ideal for individuals who routinely produce, analyze or utilize survey data. Individuals who work in government, nonprofit and research organizations will benefit from this program. Completion of this program will enhance employment opportunities for expanding professions that demand evidence-based research regarding social issues and conditions.</p>
                                            <p>This fully online program will afford you the opportunity to:</p>
                                            <p>• Update your research skills and demonstrate knowledge in Mixed Methods Research<br>
                                                • Add a valuable credential to your resume/vitae to help advance your career<br>
                                                • Complete the certificate in as little as one calendar year (While this is technically possible, it may not be advisable based on your work and family responsibilities.)<br>
                                                • Incorporate the certificate into a UNL master’s degree in Quantitative, Qualitative and Psychometrics Methods, or other graduate program with advisor approval<br>
                                                • Gain critical foundational skills needed for doctoral work<br>
                                                • A basic knowledge of designing a survey<br>
                                                • The skills necessary to conduct and manage a survey project<br>
                                                • An understanding of the statistical procedures used to process and analyze survey data</p>
                            ...
                            <div class="card">
                                ...
                                <div id="collapseFour" class="collapse" aria-labelledby="headingFour">
                                    <div class="card-body">
                                        This online certificate program in Research Methodology, benefits professionals at all levels who want to contribute to their organization’s performance. It is ideal for directors and company executives who want to update their research skills and understand statistical procedure and basic knowledge of how to design a survey in order for their organization to lead within its industry. The SEMP RM Certificate program is open to anyone interested in gaining and improving upon their organizational research skills.
                                    </div>
                                </div>
                            </div>
                            <div class="card">
                                ...
                                <div id="collapseSeven" class="collapse" aria-labelledby="headingSeven">
                                    <div class="card-body">
                                        <p>Students who successfully complete the SEMP online programme will receive a Certificate SEMP in Research Methodology from the Metropolitan School of Business and Management UK.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="card">
                                ...
                                <div id="collapseFive" class="collapse" aria-labelledby="headingFive">
                                    <div class="card-body">
                                        <div class="wpb_wrapper">
                                            <p>• Research Philosophy and Principles<br>
                                                • Choosing a Research Topic<br>
                                                • Research Strategy and Design<br>
                                                • Research Proposals<br>
                                                • Searching and Reviewing the Literature<br>
                                                • Critique and Argument in Research<br>
                                                • Developing a Conceptual Framework<br>
                                                • Research Ethics<br>
