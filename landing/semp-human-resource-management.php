...
<body>
    ...
    <div class="main-landing-page semp-hrm">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <div class="landing-position">
                            <div>
                                <h1 class="mba-header"><strong>SPECIAL EXECUTIVE MASTERS PROGRAMME</strong> in <strong>Human Resource Management</strong></h1>
                        ...
                        <div class="accordion mb-5" id="msbmAccordion">
                                ...
                                <div class="card-header" id="headingOne">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link btn-block" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                            SEMP in Human Resource Management <i class="fa fa-chevron-down float-right"></i>
                            ...
                            <div class="card">
                                <div class="card-header" id="headingTwo">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link collapsed btn-block" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">Is the SEMP Human Resource Management the right programme for me?<i class="fa fa-chevron-down float-right"></i>
                                            <i class="fa fa-chevron-up float-right"></i>
                                        </button>
                                    </h2>
                                </div>
                                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo">
                                    <div class="card-body">
                                        <div class="wpb_wrapper">
                                            <p>If you want to foster a sense of team spirit and camaraderie within the organisation, if your challenge is to manage the recruitment and selection of new employees as well as the training and development of new and current employees and you want to establish and administer compensations plans and employee benefit programs, then this is just the right programme for you.</p>
                                ...
                                <div class="card-header" id="headingThree">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link collapsed btn-block" type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                            Why SEMP Human Resource Management? <i class="fa fa-chevron-down float-right"></i>
                                            <i class="fa fa-chevron-up float-right"></i>
                                        </button>
                                    </h2>
                                </div>
                            ...
                            <div class="card">
                                ...
                                <div id="collapseFour" class="collapse" aria-labelledby="headingFour">
                                    <div class="card-body">
                                        <div class="wpb_wrapper">
                                            <p>SEMP (HRM) will equip you with the fundamentals needed to be effective change agents, either as an entrepreneur, manager or consultant. In addition, the programme will equip you with an awareness of business realities as they relate to Human Resources issues and real-world problem solving skills.</p>
                                            <p>By the end of three months, you will have worked through several case studies, have access to numerous online academic material, interact with peers from different countries and background and also have receive directions from the best business trainers in the business world today.</p>
                                            <p>The SEMP Human Resource Management programme is designed for entry-level managers, up to mid-level managers, senior managers or directors, consultant who are in general management role or fast approaching such position and is seeking an opportunity to obtain a richer, deeper understanding of management skills.</p>
                                            <p class="vc_custom_heading">Here are some of the people that have taken the course online:</p>

                                            <div class="wpb_wrapper">
                                                <ul style="column-count: 2">
                                                    <li>HR Managers</li>
                                                    <li>Business owners</li>
                                                    <li>Senior professionals in Human Resources</li>
                                                    <li>Professional in Human resources</li>
                                                    <li>General Managers of organizations</li>
                                                    <li>Top Government officials</li>
                                                    <li>Multinational Company Executives</li>
                            ...
                            <div class="card">
                                ...
                                <div id="collapseSeven" class="collapse" aria-labelledby="headingSeven">
                                    <div class="card-body">
                                        <p>Students who successfully complete the SEMP online programme will receive a Certificate SEMP in Human Resource Management from the Metropolitan School of Business and Management UK.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="card">
                                ...
                                <div id="collapseFive" class="collapse" aria-labelledby="headingFive">
                                    <div class="card-body">
                                        <div class="wpb_wrapper">
                                            <ul>
                                                <li>The Psychological Contract and Life in the Workplace</li>
                                                <li>HRM Strategy and its fit to Organisational Goals</li>
                                                <li>Recruitment</li>
                                                <li>Selection</li>
                                                <li>Flexibility and Fragmentation at Work</li>
                                                <li>Managing Learning at Work</li>
                                                <li>Managing Human Performance</li>
                                                <li>Managing Employee Reward</li>
                                                <li>Managing Employee Voice</li>
                                                <li>Affective Well Being</li>
                                                <li>Managing teams</li>
                                                <li>Ethics and Diversity in People Management</li>
                                            </ul>
