...
<body>
    ...
    <div class="main-landing-page fin-mgt">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <div class="landing-position">
                            <div>
                                <h1 class="mba-header"><strong>SPECIAL EXECUTIVE MASTERS PROGRAMME</strong> in <strong>Financial Management</strong></h1>
                        ...
                        <div class="accordion mb-5" id="msbmAccordion">
                                ...
                                <div class="card-header" id="headingOne">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link btn-block" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                            SEMP in Financial Management <i class="fa fa-chevron-down float-right"></i>
                            ...
                            <div class="card">
                                <div class="card-header" id="headingTwo">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link collapsed btn-block" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">Is the SEMP Financial Management the right programme for me?<i class="fa fa-chevron-down float-right"></i>
                                            <i class="fa fa-chevron-up float-right"></i>
                                        </button>
                                    </h2>
                                </div>
                            ...
                            <div class="card">
                                <div class="card-header" id="headingThree">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link collapsed btn-block" type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                            Why SEMP Financial Management? <i class="fa fa-chevron-down float-right"></i>
                                            <i class="fa fa-chevron-up float-right"></i>
                                        </button>
                                    </h2>
                                </div>
                                <div id="collapseThree" class="collapse" aria-labelledby="headingThree">
                                    <div class="card-body">
                                        <div class="wpb_wrapper">
                                            <p>SEMP Financial Management help participants to develop the skills to analyze company financial data accurately and strategically in this online program, it focused on improving executive decision making. Whether your concern is your own company, competitors, or potential acquisitions, you will master tools and techniques that give you a comprehensive view of any business, so you can monitor and forecast performance, measure profitability, assess competitiveness, and analyze restructuring opportunities.</p>
                                            <p class="accordion-title">Other Benefits include:</p>
                                            <p>• Financial management plays an involved role in the health of the overall economy, which impacts everyone, regardless of whether or not they have studied finance.<br>
                                                • Like companies, individuals are faced with investment and financing decisions. Having a firm grasp of finance will help individuals make those decisions.<br>
                                                • All businesses functions deal with finance because they need to be able to make the financial argument for the funding of their projects and to manage their budgets.<br>
                                                Who should enroll in this online Certificate Program?<br>
                                                • Advisors working with private equity, including investment bankers, consultants, corporate lawyers or accountants<br>
                                                • Finance professionals and senior executives who want to understand the implications of private equity for their business, or who want to work in the industry<br>
                                                • Investors, from pension fund managers to wealth managers seeking to deepen their knowledge of private equity to inform decisions<br>
                                                • Entrepreneurs or senior executives from large companies seeking private equity funding<br>
                                                • Private equity professionals wishing to benefit from the latest research and practice</p>
                            ...
                            <div class="card">
                                ...
                                <div id="collapseFour" class="collapse" aria-labelledby="headingFour">
                                    <div class="card-body">
                                        <div class="wpb_wrapper">
                                            <p>Students who successfully complete the SEMP online programme will receive a Certificate SEMP in Financial Management from the Metropolitan School of Business and Management UK.</p>
                                ...
                                <div id="collapseFive" class="collapse" aria-labelledby="headingFive">
                                    <div class="card-body">
                                        <div class="wpb_wrapper">
                                            <p>• Introduction<br>
                                                • Sources of Funds<br>
                                                • Financial Reporting to External Stakeholders<br>
                                                • Cash Flow<br>
                                                • Assessment of Financial Performance<br>
                                                • Management Control -Theories and Models<br>
                                                • Strategic Control Issues<br>
                                                • The Nature of Costs<br>
                                                • Calculation and Use of Full Cost Techniques<br>
                                                • Accounting in Support of Decision-Making<br>
                                                • Budgeting<br>
