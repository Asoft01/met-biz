...
<body>
    ...
    <div class="main-landing-page stbm">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <div class="landing-position">
                            <div>
                                <h1 class="mba-header"><strong>SPECIAL EXECUTIVE MASTERS PROGRAMME</strong> in <strong>Strategic Business Management</strong></h1>
                        ...
                        <div class="accordion mb-5" id="msbmAccordion">
                                ...
                                <div class="card-header" id="headingOne">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link btn-block" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                            SEMP in Strategic Business Management <i class="fa fa-chevron-down float-right"></i>
                                ...
                                <div id="collapseOne" class="collapse show" aria-labelledby="headingOne">
                                    <div class="card-body">
                                        <div class="wpb_wrapper">
                                            <p>Gaining deep insight into successful business strategies is a must for business professionals and managers alike. That’s because no matter where you are in your career, it’s critical to understand the market your business is in and the effect your leadership and decision making can have on your company’s success. How else can you maintain your company’s value proposition, increase market share and remain competitive?</p>
                            ...
                            <div class="card">
                                <div class="card-header" id="headingTwo">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link collapsed btn-block" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">Is the SEMP Strategic Business Management the right programme for me?<i class="fa fa-chevron-down float-right"></i>
                                            <i class="fa fa-chevron-up float-right"></i>
                                        </button>
                                    </h2>
                                </div>
                            ...
                            <div class="card">
                                <div class="card-header" id="headingThree">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link collapsed btn-block" type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                            Why SEMP Strategic Business Management? <i class="fa fa-chevron-down float-right"></i>
                                            <i class="fa fa-chevron-up float-right"></i>
                                        </button>
                                    </h2>
                                </div>
                                <div id="collapseThree" class="collapse" aria-labelledby="headingThree">
                                    <div class="card-body">
                                        <div class="wpb_wrapper">
                                            <p>Strategic management is important because is helps in setting detailed goals, analysing all our internal and external resources, analyzing our external environment, as well as stakeholder views. Good corporate governance needs an efficient strategic management process.</p>
                            ...
                            <div class="card">
                                ...
                                <div id="collapseFour" class="collapse" aria-labelledby="headingFour">
                                    <div class="card-body">
                                        <p>This online master certificate program benefits professionals at all levels who want to contribute to their organization’s performance. It is ideal for directors and company executives who determine strategic direction and position their organization to lead within its industry. The SEMP SBM Certificate program is open to anyone interested in gaining and improving upon their organizational management skills.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="card">
                                ...
                                <div id="collapseSeven" class="collapse" aria-labelledby="headingSeven">
                                    <div class="card-body">
                                        <p>Students who successfully complete the SEMP online programme will receive a Certificate SEMP in Strategic Business Management from the Metropolitan School of Business and Management UK.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="card">
                                ...
                                <div id="collapseFive" class="collapse" aria-labelledby="headingFive">
                                    <div class="card-body">
                                        <div class="wpb_wrapper">
                                            <p>• What is Strategy?<br>
                                                • Understanding Strategic Management<br>
                                                • Understanding the Competitive Environment<br>
                                                • Analyzing the Competitive Environment<br>
                                                • Stakeholder Analysis, Organisational Purpose and Organisational Vision<br>
                                                • Understanding Core Competence<br>
