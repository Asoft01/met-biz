	...
	<center style="width: 100%; background-color: #f1f1f1;">
		...
		<div style="max-width: 800px; margin: 0 auto;" class="email-container">
			...
			<table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;">
				...
				<tr>
					<td valign="middle" class="hero bg_white" style="background-image: url(images/bg_2.jpg); background-size: cover; height: 400px;">
							...
							<tr>
								<td valign="top" width="50%" style="padding-top: 20px;" class="services">
									<table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
										<tr>
											<td class="icon">
												<img src="images/wifi.svg" alt="" style="width: 10%; max-width: 600px; height: auto; margin: auto; display: block;">
											</td>
										</tr>
										<tr>
								...
								<td valign="top" width="50%" style="padding-top: 20px;" class="services">
									<table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
										<tr>
											<td class="icon">
												<img src="images/fast.svg" alt="" style="width: 10%; max-width: 600px; height: auto; margin: auto; display: block;">
											</td>
										</tr>
										<tr>
											<td class="text-services">
							...
							<tr>
								<td valign="top" width="50%" style="padding-top: 20px;" class="services">
									<table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
										<tr>
											<td class="icon">
												<img src="images/discount.svg" alt="" style="width: 10%; max-width: 600px; height: auto; margin: auto; display: block;">
											</td>
										</tr>
										<tr>
											<td class="text-services">
								...
								<td valign="top" width="50%" style="padding-top: 20px;" class="services">
									<table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
										<tr>
											<td class="icon">
												<img src="images/certificate.svg" alt="" style="width: 10%; max-width: 600px; height: auto; margin: auto; display: block;">
											</td>
										</tr>
										<tr>
											<td class="text-services">
												<h3>UK CPD Certificate</h3>
									...
									<table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
										<tr>
											<td class="counter-text">
												...
												<span class="name">Sold Properties</span>
											</td>
										</tr>
									</table>
								</td>
				...
				<tr>
					<td valign="middle" class="bg_black" style="padding: 2em 0;">
						<table>
							<tr>
								<td>
									<div class="text" style="padding: 0 2.5em; text-align: center;">
										<p><a href="#" class="btn btn-white-outline">Over 500+ Courses</a></p>
										<h3 style="color: #fff">Starting From &pound; 20</h3>
										<p><a href="#" class="btn btn-white">Find Out More</a></p>
									</div>
								</td>
							</tr>
						</table>
						...
						<table>
							<tr style="text-align: left;">
								<td valign="middle" width="50%" style="padding-top: 20px; text-align: left;">
									<h3 class="heading">Stay Updated On MSBM</h3>
								</td>
