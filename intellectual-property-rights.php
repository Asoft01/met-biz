                ...
                <div class='col-lg-8 worldwide-cols degree-info-accordion'>
                            ...
                            <div class="categories-select">
                                <form action="#" method="POST" id="term-select-nav">
                                    <select class="terms-category form-control" name="terms-category" onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);">
                                        ...
                                        <option value="<?php echo ROOT_DIR; ?>intellectual-property-rights.php" selected="selected">Intellectual Property Rights</option>
                    ...
                    <div class="terms-content">
                        <div class="wpb_wrapper">
                            ...
                            <p>You must not use any part of the materials on our site for commercial purposes without obtaining a license to do so from us or our licensors. If you print off, copy or download any part of our site in breach of these terms of use, your right to use our site will cease immediately and you must, at our option, return or destroy any copies of the materials you have made.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
