...
<div class='jumbotron degree-banner' style="background-image: url(images/banners/certificate-degree-min.jpg);">
                    ...
                    <div aria-label="breadcrumb">
                        <ol class="breadcrumb nav-breadcrumb-msbm">
                            ...
                            <li class="breadcrumb-item nav-breadcrumb-msbm-item active" aria-current="page">
                                International Postgraduate Certificates
                            </li>
                        </ol>
                    </div>
                    <h3>International Postgraduate Certificate</h3>
                    <p class="text-center"> <img src="<?php echo ROOT_DIR; ?>images/banners/Level 7 IPGD.jpg" class="mr-3 certificate-img-samp" alt="..."></p>
